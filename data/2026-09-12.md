...
### [3] [Ultralight Axial Dark Matter](https://arxiv.org/abs/2609.10671)
...
### [4] [On the Numerical Integration of One-Loop Cosmological Collider Signals](https://arxiv.org/abs/2609.10673)
...
### [5] [Re-examining the sensitivity of JWST to decaying axion dark matter](https://arxiv.org/abs/2609.10674)
...
### [6] [EFT Approaches to Sommerfeld Enhancement and Bound States in Singular Potentials](https://arxiv.org/abs/2609.10690)
...
### [7] [Higgsino dark matter in the Starobinsky supergravity with the MSSM in light of the LUX-ZEPLIN event](https://arxiv.org/abs/2609.11241)
...
### [8] [Might the radiation era extend back to the Big Bang? On dark matter production and the relic graviton background in quadratic gravity](https://arxiv.org/abs/2609.11750)
...
### [9] [XRISM observations of the Perseus cluster along two arms: Chaotic ICM motions probed by resonant scattering](https://arxiv.org/abs/2609.10845)
...
### [11] [A Homogenized Catalogue of Variable Stars in the Globular Cluster M22: Membership, Physical Parameters, and Distance](https://arxiv.org/abs/2609.11850)
...
### [12] [Emulator-Assisted Calibration of a Semi-Analytic Galaxy Formation Model for the Roman Galaxy Redshift Survey](https://arxiv.org/abs/2609.10680)
...
### [13] [Probing dynamics of extreme galaxies I. Dark matter content in ultra-diffuse galaxies](https://arxiv.org/abs/2609.10700)
...
### [14] [Predictions for astrometric microlensing in Gaia](https://arxiv.org/abs/2609.10705)
...
### [15] [BIND (Baryonic INpainting with Deep learning): A Field-level Emulator for Galaxy Groups and Clusters](https://arxiv.org/abs/2609.10709)
...
### [17] [The THRILS Factor: Investigating the properties of Little Red Dots (LRDs) at 3<z<6 with JWST/NIRSpec](https://arxiv.org/abs/2609.10803)
...
### [18] [Studying Outflows with Synthetic Absorption Line Spectra from High Resolution Simulations](https://arxiv.org/abs/2609.10868)
...
### [19] [Impact of LSST systematics on stellar-stream density fluctuations for dark matter](https://arxiv.org/abs/2609.10897)
...
### [20] [Fast Dynamical Modelling of Milky Way Globular Clusters -- II. Impacts of Black Hole Prescriptions](https://arxiv.org/abs/2609.10955)
...
### [21] [SPURS: An Ultra-deep View Inside the Compact, Nitrogen-Enriched Nuclei of Little Red Dots](https://arxiv.org/abs/2609.11094)
...
### [22] [Nitrogen-Loud Quasars from the Dark Energy Spectroscopic Instrument. I. Sample Selection and Basic Properties](https://arxiv.org/abs/2609.11104)
...
### [23] [Black Hole-Galaxy Correlations in Cluster Zoomed-in Simulations: GIZMO-SIMBA and TNG-Cluster](https://arxiv.org/abs/2609.11191)
...
### [24] [No Detectable One-halo Galactic Conformity Signal with Halo-mass Estimates Consistent with Weak-lensing Constraints](https://arxiv.org/abs/2609.11313)
...
### [25] [Constraints on the fuzzy dark matter mass using globular clusters in dwarf galaxies from Euclid ERO data](https://arxiv.org/abs/2609.11328)
...
### [26] [The properties of central stellar knots embedded in galactic bulges of CIELO simulations](https://arxiv.org/abs/2609.11465)
...
### [27] [Tracing Warm Gas through C IV Radiative Transfer](https://arxiv.org/abs/2609.11487)
...
### [28] [Resonantly Scattered CIV Emission in Local Star-forming Galaxies: Radiative Transfer Constraints on High-ionization Gas in Reionization Analogs](https://arxiv.org/abs/2609.11497)
...
### [29] [Generating the wide sequence of Diffuse Galaxies with de Broglie waves of Dark Matter](https://arxiv.org/abs/2609.11510)
...
### [30] [Testing Chemical Tagging with LAMOST: Intrinsic Abundance Dispersion of Subgiant Stars in the Galactic Disk](https://arxiv.org/abs/2609.11555)
...
### [32] [Learning JWST. I. A Foundation Model for New Population Discoveries and Morphology-Aware Photometric Redshift Measurements in the JADES Survey](https://arxiv.org/abs/2609.11879)
...
### [33] [Dark Matter-Baryon Separability Predicts the Dynamics of an Almost-Dark Galaxy](https://arxiv.org/abs/2609.10661)
...
### [34] [Aletheia: Emulating the halo mass function with evolution mapping](https://arxiv.org/abs/2609.10665)
...
### [35] [The relevance of the cosmic microwave background for cosmology](https://arxiv.org/abs/2609.10672)
...
### [36] [PBH runaway during reheating](https://arxiv.org/abs/2609.10696)
...
### [37] [BINDing the lightcone: A suite of astrophysical ray-traced weak lensing and SZ maps](https://arxiv.org/abs/2609.10710)
...
### [38] [$w_0w_a$ or $bc$: DESI constraints on relative baryon-CDM perturbations](https://arxiv.org/abs/2609.10794)
...
### [39] [Constraining spinning primordial black holes with interstellar dust heating](https://arxiv.org/abs/2609.10985)
...
### [40] [Two-parameter continuous deformation of Starobinsky inflation as a bridge between Planck and ACT DESI data with $N_\star\in(50,60)$](https://arxiv.org/abs/2609.10991)
*G. German*
...
### [41] [A Tale of Two Gauges: Effective Field Theory for Relativistic Behavior of Cosmological Axions](https://arxiv.org/abs/2609.11055)
...
### [42] [(Re)constructing Accurate Axion Oscillations](https://arxiv.org/abs/2609.11056)
*Hoang Nhan Luu,Chanda Prescod-Weinstein*
...
### [43] [SMART : Spherical Mass ApeRture Toolkit](https://arxiv.org/abs/2609.11181)
...
### [44] [Initial clustering of primordial black holes: A general formulation for arbitrary local non-Gaussianity](https://arxiv.org/abs/2609.11306)
...
### [45] [TDCOSMO XXXI: New techniques in line-of-sight studies of time delay lenses](https://arxiv.org/abs/2609.11652)
...
### [46] [Reconstructing Early Primordial Black Hole Domination from Gravitational-Wave Backgrounds](https://arxiv.org/abs/2609.11891)
...
### [47] [A Multi-Axion Ladder Across Cosmic History: From Inflation, BBN, and Early Dark Energy to Late-Time Accelerated Expansion](https://arxiv.org/abs/2609.11907)
...
### [48] [Beyond the BLUE I: the advantage ceiling - how much can any estimator beat the matched filter in mm/submm survey data?](https://arxiv.org/abs/2609.10475)
*Kaustuv Basu*
...
### [49] [Perturbations of Charged Black Holes with Higher-Order Interactions](https://arxiv.org/abs/2609.09419)
...
### [50] [Theoretical Aspects of Direct Waves in Kerr Black Holes: Pole-Splitting Method for Ringdown Analysis](https://arxiv.org/abs/2609.11908)
