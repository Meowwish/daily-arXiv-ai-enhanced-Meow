...
### [2] [Nascent Embedded-protostar Survey in Taurus (NEST) I: Protostellar Multiplicity](https://arxiv.org/abs/2608.12186)
...
### [3] [Spiral structure from the interference of gravitational eigenmodes in ultralight dark matter halos](https://arxiv.org/abs/2608.11974)
...
### [4] [Constraining the gamma-ray efficiency of LINER outflows with Fermi-LAT and MEGARA](https://arxiv.org/abs/2608.12015)
...
### [5] [A new measurement of the FRB DM-galaxy cross correlation and a first joint analysis with the kinematic SZ effect](https://arxiv.org/abs/2608.11296)
...
### [6] [MeerKAT Reveals Evidence of a Radio Megahalo at GHz Frequency](https://arxiv.org/abs/2608.12042)
...
### [7] [CIBER $\times$ galaxy cross-correlations reveal a bright, low-redshift NIR background](https://arxiv.org/abs/2608.12116)
...
### [8] [Early Exploration of the Scientific Discovery Space for the Habitable Worlds Observatory](https://arxiv.org/abs/2608.11294)
...
### [9] [From blue to red spirals: Slow galaxy transformation via ram pressure stripping in TNG-50](https://arxiv.org/abs/2608.11336)
...
### [10] [Magnetic fields in extreme primordial halos: turbulent collapse and implications for early quasar formation](https://arxiv.org/abs/2608.11400)
...
### [11] [Chemistry here and there: Comparison between the CMZ of the Milky Way and NGC 253](https://arxiv.org/abs/2608.11504)
...
### [12] [Testing Covarying Coupling Constants (CCC) against the full SPARC rotation-curve sample: a like-for-like comparison with MOND and NFW](https://arxiv.org/abs/2608.11575)
...
### [13] [Molecule-specific diffusion and desorption of interstellar ices on carbonaceous dust](https://arxiv.org/abs/2608.11729)
...
### [14] [Classifying Quasar Types Without a Spectrum](https://arxiv.org/abs/2608.11916)
...
### [15] [Search for a Globular Cluster whose Passage through the Galactic Disk could Trigger the Radcliffe Wave](https://arxiv.org/abs/2608.12028)
...
### [16] [The effect of galaxy interactions on star formation rates in the COLIBRE simulations](https://arxiv.org/abs/2608.12132)
...
### [17] [The Shape of the Vertical Action Distribution Locates the Scatterers that Heat the Galactic Disc](https://arxiv.org/abs/2608.12156)
...
### [18] [Evidence for the First Globular Cluster Stellar Stream beyond the Milky Way](https://arxiv.org/abs/2608.12254)
...
### [19] [A systematic comparison of green valley selection criteria across multiparameter spaces using a homogeneous ultraviolet-optical dataset](https://arxiv.org/abs/2608.12260)
...
### [20] [The Delay Time Distribution of Quasi-Periodic Eruptions](https://arxiv.org/abs/2608.12261)
...
### [21] [CHANG-ES XL: Magnetic Field Structures in the Disk and Halo of NGC 891](https://arxiv.org/abs/2608.12275)
...
### [22] [From Cluster Cores to the Low-Density Field: Strong Environmental Quenching of Galaxy Star Formation at Low Redshift](https://arxiv.org/abs/2608.12301)
...
### [23] [Torsional pseudo-inflation beyond Einstein-Cartan](https://arxiv.org/abs/2608.11453)
...
### [24] [Robustness of the primordial power spectrum in hybrid loop quantum cosmology to approximations near the bounce](https://arxiv.org/abs/2608.12181)
...
### [25] [A Dynamical-Photometric Phase Space for Spiral Galaxies: Probing the Local Coupling Between Light and Gravity](https://arxiv.org/abs/2608.11264)
