...
### [7] [The BGV Theorem and the Null Convergence Condition](https://arxiv.org/abs/2607.28412)
*William H. Kinney*
...
### [8] [Seesaw Cosmology](https://arxiv.org/abs/2607.27325)
...
### [9] [Dynamical flattening of halo density cusps by Q-ball dark matter](https://arxiv.org/abs/2607.28517)
...
### [10] [Systematic derivation of the Boltzmann equation for electroweak baryogenesis](https://arxiv.org/abs/2607.28321)
...
### [11] [LISA Reconstruction Landscape for Metastable Cosmic Strings](https://arxiv.org/abs/2607.28592)
...
### [12] [Comprehensive X-ray Study of Giant Radio Galaxies with XMM-Newton and Chandra](https://arxiv.org/abs/2607.27754)
...
### [13] [Semi-analytic Inference of Satellite Densities in the Cold Dark Matter Model Part II. Implications for Dark Matter Indirect Detection Constraints](https://arxiv.org/abs/2607.27326)
...
### [14] [Impact of Kaon Condensation on the Thermal Evolution of the CCO in HESS J1731--347 Supernova Remnant](https://arxiv.org/abs/2607.28107)
...
### [16] [Binary neutron stars in the next-generation era: Multi-messenger detection prospects and constraints on the equation of state, mass distribution, and cosmology](https://arxiv.org/abs/2607.28438)
...
### [17] [Non-linear Evolution of Dark Plasma Subhalos](https://arxiv.org/abs/2607.27312)
...
### [18] [Gravitational Waves as a Source of Large-Scale White Noise: New Constraints](https://arxiv.org/abs/2607.27338)
...
### [19] [DESI DR2 Results IV: Alcock-Paczyński Measurements from the Lyman Alpha Forest and Cosmological Constraints](https://arxiv.org/abs/2607.27410)
...
### [20] [Validation of the DESI DR2 Ly$α$ forest full-shape analysis](https://arxiv.org/abs/2607.27411)
...
### [21] [CoLoRe-2LPT: Lyman-$α$ mock catalogues for the validation of DESI cosmological analyses](https://arxiv.org/abs/2607.27412)
...
### [22] [Lyman-$α$ forest holography: 3D predictions from 1D measurements](https://arxiv.org/abs/2607.27413)
...
### [23] [Unified dark sector approaches to cosmological tensions](https://arxiv.org/abs/2607.27515)
...
### [24] [A study of the large-scale formation in the environment of A3266: Infalling groups, filaments, and a premerger cold front](https://arxiv.org/abs/2607.28140)
...
### [25] [Domain walls through different cosmologies](https://arxiv.org/abs/2607.28214)
...
### [26] [GGI Lectures on Large-Scale Structure Perturbation Theory (Effective Field Theory)](https://arxiv.org/abs/2607.28314)
*Mikhail M. Ivanov*
...
### [27] [Growth, geometry, and early-universe split of the matter density parameter $Ω_{\rm m}$](https://arxiv.org/abs/2607.28326)
...
### [28] [Multi-branch classification of diffuse cluster radio emission](https://arxiv.org/abs/2607.28349)
...
### [29] [Inflation, Open Universes, and Dark Energy](https://arxiv.org/abs/2607.28445)
...
### [30] [Beyond monomial $α$-attractors](https://arxiv.org/abs/2607.28502)
*Laura Iacconi*
...
### [31] [Dark Matter Constraints from Small-Scale Cosmic Structure](https://arxiv.org/abs/2607.28564)
...
### [32] [Axion Inflation with a Massive Abelian Gauge Field](https://arxiv.org/abs/2607.28593)
...
### [33] [Cosmo-SPINN: Fuzzy Dark Matter Simulations with Physics-Informed Generative Networks](https://arxiv.org/abs/2607.28604)
...
### [34] [Semi-analytic Inference of Satellite Densities in the Cold Dark Matter Model Part I. Comparison to Ultra-faint Dwarf Kinematics](https://arxiv.org/abs/2607.27316)
*Kailash Raman,Dylan Folsom,Manoj Kaplinghat,Mariangela Lisanti,Benjamin R. Safdi*
...
### [35] [Superdiffusion at the Galactic Centre](https://arxiv.org/abs/2607.27317)
...
### [36] [The influence of feedback on the baryonic content of haloes in the COLIBRE simulations](https://arxiv.org/abs/2607.27319)
...
### [37] [An Exploratory Analysis of New Large Gaia-informed Quasar Samples in SDSS-V](https://arxiv.org/abs/2607.27329)
...
### [38] [Exploring the Limits of Spectral Line Stacking in Spectral Line Data and Application Toward the Detection of Bulk $^{13}$C Enrichment of Aromatics in TMC-1](https://arxiv.org/abs/2607.27382)
...
### [39] [Cosmic Pairs: A DESI Census of Dual and Offset AGN as Precursors to Massive Black Hole Binaries](https://arxiv.org/abs/2607.27390)
...
### [40] [Stellar photoionisation modelling in SYNTHESIZER](https://arxiv.org/abs/2607.27467)
...
### [41] [Galactic HII regions in LAMOST Medium-Resolution Spectroscopic Survey of Nebulae](https://arxiv.org/abs/2607.27662)
...
### [42] [The X-ray-Weak Tail of the Quasar Population: Physical Properties and Redshift Evolution of Variability-Selected AGN in eFEDS](https://arxiv.org/abs/2607.27675)
...
### [43] [Revealing the Physical Driver of the Baldwin Effect: Gas Density in the Broad-Line Region](https://arxiv.org/abs/2607.27860)
...
### [44] [The eROSITA X-ray luminosity function of active galactic nuclei](https://arxiv.org/abs/2607.27887)
...
### [45] [Invariant manifolds in barred galaxy simulations. III. Self-regulated weakening of strong spiral arms](https://arxiv.org/abs/2607.27963)
...
### [46] [A search for HI absorption in distant star-forming galaxies with ASKAP-FLASH - II. Direct observations and stacking of 21 cm line](https://arxiv.org/abs/2607.27977)
...
### [47] [Angular Momentum Evolution from Core to Disk Scales in the Early Phase of Star Formation: Constraints from HH 212, HH 211, and B335](https://arxiv.org/abs/2607.28056)
*Chin-Fei Lee*
...
### [48] [Bipolar HII regions Produced by Cloud-Cloud Collisions](https://arxiv.org/abs/2607.28174)
...
### [49] [Searching in HI for Massive Low Surface Brightness Galaxies: II. Completing the UGC Sample](https://arxiv.org/abs/2607.28180)
...
### [50] [JWST's Constraints on the Substellar IMF in NGC 2024](https://arxiv.org/abs/2607.28278)
*K. L. Luhman*
...
### [51] [X-ray Absorption Variability in NGC 1142: Another Constraint on the Nature of the Torus/Broad-Line Region in Active Galactic Nuclei](https://arxiv.org/abs/2607.28501)
...
### [52] [Characterizing the disruption of Böotes III: a missing link in the Galactic halo?](https://arxiv.org/abs/2607.28594)
...
### [53] [Wading the String Bog: CMB Birefringence in the Swampland](https://arxiv.org/abs/2607.27318)
...
### [55] [PhoPS: An automated photometric pipeline for survey-era astronomy](https://arxiv.org/abs/2607.27414)
