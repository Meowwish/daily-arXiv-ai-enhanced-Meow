...
### [1] [Hub-Aware Hybrid Search: Accelerating the Locally Aligned Ant Technique](https://arxiv.org/abs/2606.06198)
...
### [2] [The WISSHFUL program: the highest redshift UFO discovered in a non-lensed QSO](https://arxiv.org/abs/2606.05312)
...
### [3] [Constraining Orbital Eccentricity of a Supermassive Black Hole Binary Candidate PKS 2131-0211](https://arxiv.org/abs/2606.05343)
...
### [4] [Heavy-element paleodetectors for Higgsino dark matter](https://arxiv.org/abs/2606.05299)
...
### [5] [Gravitational Wave Imprints of a High-Quality Axion and the Origin of Flavor Hierarchies](https://arxiv.org/abs/2606.05320)
...
### [6] [Sky-Plane Velocity Distributions of Interstellar Objects and Implications for Their Detection](https://arxiv.org/abs/2606.05344)
...
### [7] [Running Vacuum in the expanding Universe: a unified QFT paradigm for Inflation and Dark Energy](https://arxiv.org/abs/2606.05352)
*Joan Solà Peracaula*
...
### [9] [Short Gravitational-Wave Transients as Probes of Cosmic Domain Walls](https://arxiv.org/abs/2606.06478)
...
### [10] [GREX-PLUS Science Book v2](https://arxiv.org/abs/2606.05237)
...
### [11] [Building a Roadmap for Hubble science into the 2030s: Crucial UV spectroscopy of Oe stars in nearby galaxies](https://arxiv.org/abs/2606.05417)
...
### [12] [Behavior of kinetic instabilities in a dynamically forming resonant distribution](https://arxiv.org/abs/2606.05341)
...
### [14] [Strong environmental AGN enhancement among DSFGs in z > 2 protoclusters](https://arxiv.org/abs/2606.05283)
...
### [15] [Metal-Poor Gas Accretion Drives Giant Clump Formation at 0.6 < z < 2.6](https://arxiv.org/abs/2606.05284)
...
### [16] [Dynamical models of cluster members to probe the total mass properties of cluster subhalos. I. A comparison with parametric strong lensing models](https://arxiv.org/abs/2606.05298)
...
### [17] [A Decade to Map the Diffuse Universe: FRB-QSO Pairs with HST/COS Spectroscopy](https://arxiv.org/abs/2606.05310)
...
### [18] [Strong [OIII]$+$H$β$ emitters dominated the ionizing budget at $z\sim7$](https://arxiv.org/abs/2606.05323)
...
### [19] [Bulk vs. turbulent motions at the centres of galaxy clusters: AGN-driven turbulence according to TNG-Cluster](https://arxiv.org/abs/2606.05355)
...
### [20] [A Kinematic Study of Wolf-Rayet Stars at the Galactic Center I: Binary Candidates and Constraints on the Binary Fraction](https://arxiv.org/abs/2606.05521)
...
### [21] [A linear residual structure across galaxy rotation curves](https://arxiv.org/abs/2606.05540)
*Hosik Lee*
...
### [22] [Mapping Active Star-Formation in Serpens and the Aquila Rift](https://arxiv.org/abs/2606.05668)
...
### [23] [Evolution of the stellar mass function in open clusters from a universal and unsegregated initial state](https://arxiv.org/abs/2606.05762)
...
### [24] [WISE Photometry of Galaxies within 10 Mpc](https://arxiv.org/abs/2606.05780)
...
### [25] [Galaxy morphology dependent (black hole mass)-(velocity dispersion) relations: implications for gravitational wave forecasts and cosmological simulations](https://arxiv.org/abs/2606.05808)
*Alister W. Graham*
...
### [26] [Early Results from GLASS-JWST. XXVI. Spatially Resolved Star Formation and Balmer Decrements at $1.1<z<2.3$ from NIRISS Slitless Spectroscopy](https://arxiv.org/abs/2606.05887)
...
### [27] [Near- to Far-Infrared Spectral Energy Distribution Analysis of Interacting Galaxies in Hickson Compact Groups 56 and Stephan's Quintet (HCG 92)](https://arxiv.org/abs/2606.05908)
...
### [28] [The quenching time and timescale distribution of z~2 quiescent galaxies from precise colour distribution analysis](https://arxiv.org/abs/2606.05971)
...
### [29] [The Multi-phase Biconical Outflow in the local IR-Luminous Merger IRASF01364-1042](https://arxiv.org/abs/2606.06005)
...
### [30] [Grain-size evolution and rapid dust growth in high-redshift galaxies](https://arxiv.org/abs/2606.06108)
...
### [31] [A New Member of the Fast and Furious Family: A Relativistic and Time-Variable UV Outflow in a Luminous Quasar](https://arxiv.org/abs/2606.06226)
...
### [32] [Bar-induced deflection of open cluster tidal tails](https://arxiv.org/abs/2606.06248)
...
### [34] [Dynamical evolution and dissolution timescale of young stellar clusters in the Orion star-forming complex](https://arxiv.org/abs/2606.06457)
...
### [35] [The free-streaming length of dark matter from JWST observations of 28 strong gravitational lenses](https://arxiv.org/abs/2606.05277)
...
### [36] [AGN Line-Intensity Mapping: A Probe of Faint Black Holes at Cosmic Noon](https://arxiv.org/abs/2606.05301)
...
### [37] [The DESI results impact the local determination of $H_0$](https://arxiv.org/abs/2606.05358)
...
### [38] [On the potential for inhomogeneities to mimic an evolving dark energy](https://arxiv.org/abs/2606.05479)
...
### [39] [Dissipative Cosmology and the Nature of Dark Energy: Insights from Bulk Viscosity with DESI DR2 observations](https://arxiv.org/abs/2606.05539)
...
### [40] [Metastability in Emergent Dark Energy: A New Framework Confronting Cosmological Observations](https://arxiv.org/abs/2606.05723)
...
### [41] [Reconstructing dark energy with fewer assumptions](https://arxiv.org/abs/2606.05853)
...
### [42] [AKRA 3.0: A matrix-free Inversion Framework for Weak Lensing Mass Mapping and Its Application to DES Y3 Data](https://arxiv.org/abs/2606.06175)
...
### [43] [The Atacama Cosmology Telescope: Probing new signatures of ultralight axions with gravitational lensing](https://arxiv.org/abs/2606.06410)
...
### [44] [Phenomenology of Inflaton-Driven Early QCD Confinement and Solution to Axion Isocurvature Problem](https://arxiv.org/abs/2606.06484)
...
### [45] [What it takes to solve the Hubble tension through Modifications of Cosmological Recombination II: in light of ACT DR6 and DESI DR2](https://arxiv.org/abs/2606.06495)
