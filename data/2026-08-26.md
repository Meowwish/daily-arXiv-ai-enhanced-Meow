...
### [2] [Linking high-mass X-ray binaries to binary compact object mergers in Milky Way-like galaxies](https://arxiv.org/abs/2608.23945)
...
### [3] [Spatially resolved spectral properties of M87* on event horizon scales](https://arxiv.org/abs/2608.24110)
...
### [4] [Molecular and Atomic Gas Associated with the Gamma Ray Supernova Remnant RCW 103](https://arxiv.org/abs/2608.24187)
...
### [5] [Probing the Three-Dimensional Structure of a Jet with Faraday Tomography](https://arxiv.org/abs/2608.24490)
...
### [6] [Improving the Physical Interpretability of Gaussian Processes in Stellar Activity Modeling: A Study Case on Photometric Variability Among Stellar Clusters](https://arxiv.org/abs/2608.24701)
...
### [7] [CosmoFit: A Graphical User Interface for Bayesian Cosmological Parameter Estimation with User-Defined H(z) Models](https://arxiv.org/abs/2608.23588)
*Giovany Cruz*
...
### [8] [Exact Equivalence of the Observed Redshift and the Pulsar Timing Modulation in the Infinitesimal-Pulse Limit](https://arxiv.org/abs/2608.23684)
...
### [9] [Beyond $w_0-w_a$ and Phantom Crossing: Testing Models of Coupled Dark Sector](https://arxiv.org/abs/2608.23712)
...
### [10] [A New Probe of Dark Matter Subhalos: Stellar Aberration with TESS](https://arxiv.org/abs/2608.23795)
...
### [11] [Projected Constraints on Primordial Black Holes from Scalar-Induced Gravitational Waves with Taiji](https://arxiv.org/abs/2608.23957)
...
### [12] [The Effect of Slitless Spectroscopic Redshift Uncertainty and Interlopers on BAO Measurements from CSST-like Samples](https://arxiv.org/abs/2608.24276)
...
### [13] [A "MeerKAT-meets-LOFAR" Study of 2A 0335+096: Discovery of a Complex 500 kpc Radio Halo in a Disturbed Cool-Core Cluster](https://arxiv.org/abs/2608.24309)
...
### [14] [The Primordial power spectrum from the largest to smallest CMB scales](https://arxiv.org/abs/2608.24413)
...
### [15] [Dark-to-black super-accretion as a spin-imprinting mechanism for supermassive Kerr black holes](https://arxiv.org/abs/2608.24432)
...
### [16] [Gaussian process reconstruction of scalar field dynamics from recent cosmological data](https://arxiv.org/abs/2608.24433)
...
### [17] [CMB Birefringence from Axion String Networks Calibrated to an AMR Simulation](https://arxiv.org/abs/2608.24456)
...
### [18] [Constraining the Tilted Dipole Cosmology with Primordial Nucleosynthesis and Baryogenesis](https://arxiv.org/abs/2608.24501)
*Mohsen Khodadi*
...
### [19] [First application of weak lensing peak steepness statistics to HSC Y1 data: effectively probing halo density profiles](https://arxiv.org/abs/2608.24591)
...
### [20] [Chebyshev interpolation in Einstein-Boltzmann codes](https://arxiv.org/abs/2608.24682)
*Herman Sletmoen*
...
### [21] [The impact of the IGM thermal state on the Ly$α$ flux 3D power spectrum from linear to highly non-linear scales](https://arxiv.org/abs/2608.24784)
...
### [22] [Impact of Scale-dependent Primordial Non-Gaussianity on Scalar-induced Gravitational Waves](https://arxiv.org/abs/2608.24883)
...
### [23] [When the HL-LHC is blind, LISA is deaf (but not vice versa): 2HDM collider-cosmology synergies](https://arxiv.org/abs/2608.23679)
...
### [24] [Topics in the phenomenology of axions: the cases of cosmic strings and superradiance](https://arxiv.org/abs/2608.23789)
*Antonios Kyriazis*
...
### [25] [Determination of $H_{0}$ with a Photometric AGN Golden Sample derived from a joint SN Ia-QSO cosmological reconstruction](https://arxiv.org/abs/2608.23579)
*Sebastian Rueda-Blanco,Mario A. Higuera-G.,Camilo Delgado-Correal*
...
### [28] [Constraining the Inner Dark-Matter Slope of Sculptor: A Comparative Analysis of Dynamical Methods](https://arxiv.org/abs/2608.23618)
*Rishi Sanjeev*
...
### [29] [More Numerous and Bluer: Companions of the Brightest Little Red Dots Differ from Control Galaxies at $>3σ$, Hinting at Synchronized Black Hole Seed Formation](https://arxiv.org/abs/2608.23671)
...
### [30] [Spin inference with the Black Hole Explorer. I. Fisher information matrix forecast](https://arxiv.org/abs/2608.23672)
...
### [31] [A simulation-based quality-control framework for the broad-line region radius-luminosity relation](https://arxiv.org/abs/2608.23673)
...
### [32] [Cool CGM MgII Absorption Across the Star-Forming, Green Valley, and Quiescent Transition](https://arxiv.org/abs/2608.23687)
...
### [33] [The Evolution of Low-Ionization Electron Densities in Galaxies Across Cosmic Epochs](https://arxiv.org/abs/2608.23846)
...
### [34] [The Local Origin of a Host Dispersion Measure-Stellar Mass Relation in Fast Radio Bursts](https://arxiv.org/abs/2608.23868)
...
### [35] [Comparing the Nebular and Stellar Dust Attenuation Curves in Nearby Star-Forming Galaxies](https://arxiv.org/abs/2608.24123)
...
### [36] [Interplay of Compaction, Quenching, and Black Hole Growth in the Most Massive Galaxies since $z\sim5$: Insights from JWST and Chandra Data](https://arxiv.org/abs/2608.24124)
...
### [37] [Decoupling candidate dual AGN from chance superpositions in the GOTHIC survey via a deep-learning framework](https://arxiv.org/abs/2608.24164)
...
### [38] [SDSS-IV MaNGA: Star Formation Cessation in Low-redshift Galaxies. III. Dependence on Quenching Criteria](https://arxiv.org/abs/2608.24201)
...
### [39] [An HI study of a large sample of ultra-diffuse galaxies](https://arxiv.org/abs/2608.24225)
...
### [40] [Synchrotron filaments in radio galaxies: rarity, stability, and environmental influences from LOFAR and ROSAT observations](https://arxiv.org/abs/2608.24321)
...
### [41] [Interstellar Aromatic Infrared Bands: IR absorption spectroscopy of the lowest triplet state of naphthalene](https://arxiv.org/abs/2608.24395)
...
### [42] [Estimator forensics for the wide-binary gravity test: the eccentricity-triple coupling manufactures a pseudo-signal, and a pre-registered protocol for Gaia DR4](https://arxiv.org/abs/2608.24556)
*Hicham Boufourou*
...
### [43] [Broad Paschen lines as black hole mass tracers: A reverberation mapping calibration](https://arxiv.org/abs/2608.24645)
...
### [44] [Spatially resolved molecular gas conditions in the circumnuclear disc of 3C 84](https://arxiv.org/abs/2608.24678)
...
### [45] [The Mass Dependence of the Fundamental Metallicity Relation in Observations and Simulations](https://arxiv.org/abs/2608.24826)
...
### [46] [The Highly Unusual Behavior and Chemical Composition of Interstellar Comet 2I/Borisov](https://arxiv.org/abs/2608.23701)
...
### [47] [An analysis of the Herbig star population and their protoplanetary disks within 1 kpc](https://arxiv.org/abs/2608.23729)
...
### [48] [Occultation of microlensed images by circum-lens disks: Implications for surveys](https://arxiv.org/abs/2608.24009)
*Elizabeth Bailey*
...
### [49] [Flyby-induced high-eccentricity migration and the prevalence of hot Jupiters in M67](https://arxiv.org/abs/2608.24874)
