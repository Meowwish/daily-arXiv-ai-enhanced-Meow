...
### [2] [CHORD HI-Galaxy Survey Forecasts: Searching for nearby dark galaxies and high redshift giants](https://arxiv.org/abs/2607.24903)
...
### [3] [Vigorous turbulence driven by quasar-mode feedback in a cluster core](https://arxiv.org/abs/2607.24911)
...
### [4] [Observational Evidence for Anisotropic Metal Excess around Galaxies](https://arxiv.org/abs/2607.24929)
...
### [5] [S301 and friends: Measuring the spin of Sgr A*](https://arxiv.org/abs/2607.24931)
...
### [6] [Using Scattered Near-Infrared Light to Map Water Ice in Prestellar Cores with SPHEREx](https://arxiv.org/abs/2607.24934)
...
### [7] [Reaching the Metallicity Floor at $z\sim 10$: Lensed Star Clusters at Cosmic Dawn and Cosmic Noon](https://arxiv.org/abs/2607.24952)
...
### [8] [Observational Tests of Sgr A*'s State of the Accretion Flow](https://arxiv.org/abs/2607.24966)
...
### [9] [The $σ_s^2-\mathcal{M}$ relation in the multi-phase ISM: Exploring the density PDF with the Cloud Factory simulations](https://arxiv.org/abs/2607.24977)
...
### [10] [How massive and clumpy must a quasar wind be to create emission line blueshifts?](https://arxiv.org/abs/2607.25035)
*James H. Matthews*
...
### [11] [A Deep Look at the Ultra-Faint Milky Way Satellite Virgo III with Rubin Observatory Data Preview 2](https://arxiv.org/abs/2607.25044)
...
### [12] [Linking dynamics and chemistry in barred galaxies through action-space mapping](https://arxiv.org/abs/2607.25052)
...
### [13] [Radiation-Driven Evolution and Gas Kinematics of the Bright-Rimmed Cloud SFO 25](https://arxiv.org/abs/2607.25083)
...
### [14] [From Starburst to Quenching: Physical Properties of Extremely Compact Starbursts at z$\sim$0.1](https://arxiv.org/abs/2607.25290)
...
### [25] [Compiling the largest multiwavelength database of known changing-look AGN: Prospects in the Rubin era](https://arxiv.org/abs/2607.25839)
...
### [26] [A new look at old devils. II: New insights on classical radio galaxies from MeerKAT and uGMRT](https://arxiv.org/abs/2607.25867)
...
### [27] [The influence of dust destruction on gas cooling](https://arxiv.org/abs/2607.25934)
...
### [28] [The evolution of galaxy dust scaling relations in the COLIBRE simulations](https://arxiv.org/abs/2607.26058)
...
### [29] [KMT-2025-BLG-0975Lb and KMT-2025-BLG-1160Lb: Two Uranus-Mass Planets Beyond the Snow Line Discovered by Microlensing](https://arxiv.org/abs/2607.25259)
...
### [30] [Cosmological evolution with decaying dark matter: an integral-equation approach](https://arxiv.org/abs/2607.24910)
...
### [31] [Correlated signals of ultralight scalar dark matter in pulsar timing](https://arxiv.org/abs/2607.24912)
...
### [32] [Interlopers as Signal in Line Intensity Mapping](https://arxiv.org/abs/2607.24917)
*Anirban Roy*
...
### [33] [Primordial Physics in the Nonlinear Universe: Revealing the oscillating halo bias from cosmological collider models](https://arxiv.org/abs/2607.24939)
...
### [34] [EFT-Ramses: a code to simulate the effective field theory of dark energy](https://arxiv.org/abs/2607.24940)
...
### [35] [CosmoLattice 2.0](https://arxiv.org/abs/2607.24978)
...
### [36] [Gravitational Waves from Superconducting Cosmic Strings](https://arxiv.org/abs/2607.25317)
...
### [37] [Neutrino-electron scattering kernels in isotropic media](https://arxiv.org/abs/2607.25436)
...
### [38] [No preference for generalized emergent dark energy from current cosmological data](https://arxiv.org/abs/2607.25539)
...
### [39] [Simulation-based tension quantification of the cosmic dipole](https://arxiv.org/abs/2607.25703)
...
### [40] [Robust Ly$α$ forest constraints on reionization from semi-analytic galaxy formation models](https://arxiv.org/abs/2607.25722)
...
### [41] [Anisotropic Secondary Bias of Dark Matter Haloes in a $Λ$CDM Universe](https://arxiv.org/abs/2607.26009)
*Qinglin Ma,Cheng Li*
...
### [42] [Weighted Webs: Morphology-Informed Marked Fields](https://arxiv.org/abs/2607.26021)
...
### [43] [Minimally modified gravity with Laplacian auxiliary constraints and an inflationary realization](https://arxiv.org/abs/2607.26031)
...
### [44] [Probing Parity Violation with Weak Lensing Trispectrum](https://arxiv.org/abs/2607.26046)
...
### [45] [$Λ$XCDM: a running vacuum strategy for crossing the phantom divide](https://arxiv.org/abs/2607.26050)
...
### [46] [TempLat: a versatile C++ engine for lattice field theories](https://arxiv.org/abs/2607.24908)
...
### [47] [Tightening Bounds on Warm Dark Matter with High-Redshift Gamma-Ray Bursts](https://arxiv.org/abs/2607.25261)
...
### [49] [LiteBIRD Mission Overview after Mission Reformation](https://arxiv.org/abs/2607.25285)
...
### [50] [AI's Capability in Assisting Scientific Research in Physics, Astrophysics, and Cosmology I: Literature Review](https://arxiv.org/abs/2607.25672)
...
### [51] [The IMF package: a toolkit implementing mass functions and statistical tools to analyze them](https://arxiv.org/abs/2607.26007)
...
### [52] [Investigating the Observational Progenitor Mass Gap in the White Dwarf Initial-Final Mass Relation. I. Cluster Census and Characterization of the First White Dwarfs in the Gap](https://arxiv.org/abs/2607.24941)
...
### [53] [Project Hephaistos -- III. Characterizing anomalous infrared sources identified as Dyson-sphere candidates](https://arxiv.org/abs/2607.25701)
...
### [54] [JWST/MIRI Detection of Molecular H$_2$ Winds from an Edge-on Class II Source HV Tau C](https://arxiv.org/abs/2607.25770)
...
### [55] [Multiclass Classification without Labels via Posterior Simplex Geometry](https://arxiv.org/abs/2607.24943)
...
### [57] [Fixing IR tail of gravitational waves from domain walls](https://arxiv.org/abs/2607.25073)
...
### [58] [General Relativistic Entropic Acceleration at the perturbation level: a CLASS implementation and first Boltzmann-code constraints](https://arxiv.org/abs/2607.25841)
...
### [59] [Analytic backreaction of a scalar wig on a Schwarzschild black hole](https://arxiv.org/abs/2607.25932)
