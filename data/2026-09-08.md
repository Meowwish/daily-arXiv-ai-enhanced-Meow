...
### [1] [Probing Dark Matter with Strongly Lensed Binary Black Hole Mergers: Prospects in the Near Future](https://arxiv.org/abs/2609.05020)
...
### [2] [Fast Bayesian Inference for Long-Duration Gravitational-Wave Signals in 3G detectors](https://arxiv.org/abs/2609.05375)
*Anand S. Sengupta*
...
### [3] [Multi-Wavelength Post-Perihelion Polarimetry of Interstellar Comet 3I/ATLAS](https://arxiv.org/abs/2609.04932)
...
### [4] [Enabling Metallicity Measurements of Microlensing Lenses through Multi-band Lens Photometry](https://arxiv.org/abs/2609.05265)
...
### [5] [Ion abundances in the plasma tail of 3I/ATLAS show that it is N2-rich](https://arxiv.org/abs/2609.05393)
...
### [6] [ALPACA I: Controlling source and PSF systematics in JWST time-delay cosmography with differentiable lens modeling](https://arxiv.org/abs/2609.04312)
...
### [7] [Supernova microlensing as a probe of ultracompact minihalos and primordial cosmology](https://arxiv.org/abs/2609.04308)
...
### [8] [It's All About the Environment: Local $f_{\rm NL}$ from a Dark Matter Conditioned Multitracer Analysis](https://arxiv.org/abs/2609.04313)
...
### [9] [Model Predictive Scoring Shows Specific BAO Observations (not SNIa) Drives $w_0w_a$ Tension](https://arxiv.org/abs/2609.04334)
...
### [10] [The Super-Sample Covariance of Line-Intensity Mapping Power Spectrum](https://arxiv.org/abs/2609.04488)
...
### [11] [Implementation of frequency-correlated noise in CMB component separation: Method, Validation, and Early Applications](https://arxiv.org/abs/2609.04510)
...
### [12] [Studies on the dark sector interaction from joint analysis of cosmological probes](https://arxiv.org/abs/2609.04746)
...
### [14] [Late-Time Emergence of Dark Energy and Its Interaction with Dark Matter](https://arxiv.org/abs/2609.04990)
...
### [15] [Expanding the scope of dark siren cosmology: Inferring the population properties of gravitational wave-hosting galaxies](https://arxiv.org/abs/2609.04991)
...
### [16] [Supernovae Unite: Combining Pantheon+ and DES-SN5YR](https://arxiv.org/abs/2609.05053)
...
### [17] [Euclid. A two-point correlation approach to diagnosing star-related systematics in the Euclid spectroscopic survey](https://arxiv.org/abs/2609.05155)
...
### [18] [Supernovae Unite: Host-Galaxy Mass Measurements of Type Ia Supernovae and Their Impact on Cosmology](https://arxiv.org/abs/2609.05321)
...
### [19] [Early against Late: A contrast on dark energy in the light of DESI DR2](https://arxiv.org/abs/2609.05410)
...
### [20] [Tracing the Cosmic Origins: Machine Learning Reconstruction of the Primordial Density Field from EoR Observations](https://arxiv.org/abs/2609.05412)
...
### [21] [Nebular Spectra of the Extremely Metal-Poor SN II 2023ufx Over a Year After Explosion: A Massive Progenitor and Unique Circumstellar Environment](https://arxiv.org/abs/2609.04307)
...
### [22] [A Kinematic Measurement of the Effective Viscosity of the Intracluster Medium: The Cold Front of A3667 Seen by XRISM](https://arxiv.org/abs/2609.04316)
...
### [23] [JWST/NIRSpec Reveals Diverse Nuclear Environments in Dwarf Galaxies Hosting AGN](https://arxiv.org/abs/2609.04315)
...
### [24] [Super-Eddington Accretion and Early-Stage Feedback in Ton S180](https://arxiv.org/abs/2609.04317)
...
### [25] [Resolved Dust-Gas-Metallicity relations in nearby spiral galaxies](https://arxiv.org/abs/2609.04320)
...
### [26] [AGN-DB: A Unified Multi-Wavelength Database of Active Galactic Nuclei](https://arxiv.org/abs/2609.04322)
...
### [27] [Recovering Ionizing Photon Escape and Galaxy Scaling Relations in the LzLCS via Si II and C II Absorption Lines and Mock Spectra from a Radiation-Hydrodynamic Simulation](https://arxiv.org/abs/2609.04324)
...
### [28] [Widespread Inflows Reveal Baryonic Cycling in Star-forming and Quiescent Galaxies](https://arxiv.org/abs/2609.04327)
...
### [29] [H I Absorbers as Beacons of Hidden Structure at $z \sim 3$: Multi-Component, Metal-Rich Absorption System near a Protocluster](https://arxiv.org/abs/2609.04349)
...
### [30] [Extending the Stellar-to-Halo Mass Relation to Dwarf Galaxies with DESI DR1](https://arxiv.org/abs/2609.04351)
...
### [31] [Hint of bimodal Mg-Al anticorrelation in the metal-poor Globular Cluster NGC 4372](https://arxiv.org/abs/2609.04361)
...
### [32] [Linking orbital history to the quenching of isolated dwarf galaxies](https://arxiv.org/abs/2609.04385)
...
### [33] [KKR 18: A Late Arrival Galaxy?](https://arxiv.org/abs/2609.04437)
...
### [34] [Star Formation Evolution in Galaxy Pairs: Constraints from Morphological Disturbances and Recent Star Formation Histories](https://arxiv.org/abs/2609.04560)
...
### [35] [Membership Determination of 45 Open Clusters Beyond 3 kpc](https://arxiv.org/abs/2609.04857)
...
### [36] [Quantifying collision-driven mass loss in supermassive star formation: the role of stellar structure and accretion](https://arxiv.org/abs/2609.04892)
...
### [37] [Rubin J122659.4+090236: An Extremely Low Surface Brightness Galaxy Candidate Discovered in the Rubin LSST Early Data Preview 2](https://arxiv.org/abs/2609.04967)
...
### [38] [Corona Australis 151: an extremely young protostar](https://arxiv.org/abs/2609.05026)
...
### [39] [PPN--spin degeneracies in mock S62-like stellar-orbit inference](https://arxiv.org/abs/2609.05172)
*Shant Khlghatyan*
...
### [40] [The dispersal law of young star clusters: free expansion -- A Gaia/eROSITA census of Orion and Sco--Cen](https://arxiv.org/abs/2609.05179)
...
### [41] [Stellar Population and Dynamical Modeling of Galaxies with Kinematically Misaligned Components: Age and Metallicity of Structural Components](https://arxiv.org/abs/2609.05216)
...
### [42] [Rapid quenching and early gas depletion in the core of a galaxy protocluster at z=2.2](https://arxiv.org/abs/2609.05285)
...
### [43] [The DESI Data Release 1 white dwarf catalogue](https://arxiv.org/abs/2609.04314)
...
### [44] [Can isolated binaries form unequal-mass binary black-hole mergers with a high-spin primary black hole?](https://arxiv.org/abs/2609.05128)
...
### [45] [ROCKETS I: Investigating the Impact of the Rocket Effect on Two Nearby Young Open Clusters Encased in Infrared Bubbles](https://arxiv.org/abs/2609.05272)
...
### [46] [Metallicity dependence of Wolf-Rayet binaries using detailed binary models: An absence of long-period systems at low metallicity](https://arxiv.org/abs/2609.05398)
