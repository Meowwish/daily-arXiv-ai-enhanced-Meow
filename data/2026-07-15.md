...
### [1] [Stochastic Tsunamis: Diffuse Scalar Background from Black Hole Formation](https://arxiv.org/abs/2607.12013)
...
### [2] [How invisible can QCD axions be? From Supernova emission to Cherenkov signals](https://arxiv.org/abs/2607.12025)
...
### [3] [Measuring Ultralight-Axion Coherence with Galaxy Polarization Correlations](https://arxiv.org/abs/2607.12446)
*Yasuo Doi*
...
### [4] [Neutrino superradiance constraint on asteroid-mass PBH Dark Matter and beyond](https://arxiv.org/abs/2607.12485)
...
### [7] [The Carbon-Dependent Binary Frequency of CEMP-no Stars](https://arxiv.org/abs/2607.13020)
...
### [8] [Search for GeV gamma-ray emission from PSZ G181.06+48.47 galaxy cluster using Fermi-LAT data](https://arxiv.org/abs/2607.11316)
...
### [9] [Astrophysical Population Coordinates for Supermassive Black Hole Binaries in Pulsar Timing Array Inference](https://arxiv.org/abs/2607.12427)
...
### [10] [EP-FXT Observations of Abell 1795: X-ray Properties and Structure out to $R_{200}$](https://arxiv.org/abs/2607.12816)
...
### [11] [Dynamics and observational signatures of warm Dirac-Born-Infeld inflation with nonminimal derivative coupling](https://arxiv.org/abs/2607.11519)
...
### [12] [Beyond ΛCDM with the SKA Observatory -- I: Probing Gravity on Cosmological Scales](https://arxiv.org/abs/2607.11917)
...
### [13] [Dynamics of potential-free warm $\mathbf{k}$-inflation with nonminimal derivative coupling](https://arxiv.org/abs/2607.12280)
...
### [14] [Axion like particles multi-parameter sensing](https://arxiv.org/abs/2607.12164)
...
### [15] [Quantifying Foreground Contamination in the Dark Ages 21 cm Power Spectrum Using an Electromagnetically Simulated Dipole Antenna Atop a Dielectric Surface](https://arxiv.org/abs/2607.11929)
...
### [16] [Status and future development of the COSMOCal Project for absolute CMB polarization calibration](https://arxiv.org/abs/2607.12698)
...
### [17] [Demystifying image-recovery from radio interferometers: toward a multiscale predictive model](https://arxiv.org/abs/2607.12396)
...
### [18] [Detecting alien living worlds and photosynthetic life using imaging polarimetry with the HWO coronagraph](https://arxiv.org/abs/2507.03819)
...
### [19] [Probing the Innermost Region of the V883 Ori Disk Using ALMA Band 1 Methanol Line Observations](https://arxiv.org/abs/2607.12005)
...
### [20] [MOA-2020-BLG-108Lb: A Giant Planet Beyond the Snow Line of a Low-Mass Lens Near the Lower Boundary of the Mass-Ratio Desert](https://arxiv.org/abs/2607.12081)
...
### [21] [A Fast Concentric-disk Contour Integration Method For Microlensing Limb-darkening Effect](https://arxiv.org/abs/2607.12483)
*Suwei Wang*
...
### [22] [The Limitations of Cosmological Collider Analyses](https://arxiv.org/abs/2607.12010)
*Oliver H. E. Philcox*
...
### [23] [Using SquiRels to Find LiMRs: A Model-Insensitive Approach to Cosmic Microwave Background Studies of Light but Massive Relics](https://arxiv.org/abs/2607.12021)
...
### [24] [Mitigating galaxy systematics with gravitational wave clustering](https://arxiv.org/abs/2607.12049)
...
### [25] [Solar System Probes for Scalar Field Dark Matter](https://arxiv.org/abs/2607.12144)
...
### [26] [Testing the Direction of Dark Sector Interaction Using Late-Time Datasets](https://arxiv.org/abs/2607.12283)
...
### [27] [Ricci Focusing Degeneracy between Dynamical Dark Energy and Matter Inhomogeneity](https://arxiv.org/abs/2607.12424)
...
### [28] [Exploring Hu-Sawicki-like modified gravity with Genetic Algorithms](https://arxiv.org/abs/2607.12745)
...
### [29] [Overview: Cosmology with the SKAO](https://arxiv.org/abs/2607.12887)
...
### [30] [Models with Non-minimal Coupling in Primordial Universe and Cosmological Observations](https://arxiv.org/abs/2607.12974)
...
### [31] [Model-Independent Indication for a Localized Anomaly in the Late-Time Expansion History](https://arxiv.org/abs/2607.13009)
...
### [32] [A Universal Distribution of Dark Matter in Milky Way-like galaxies and How to Infer It](https://arxiv.org/abs/2607.12008)
...
### [33] [Evolution of Binaries Under Stochastic Perturbations](https://arxiv.org/abs/2607.12011)
...
### [34] [The onset of stellar bars at Cosmic Noon. Bar-driven quenching and AGN co-evolution in a mature disc galaxy](https://arxiv.org/abs/2607.12016)
...
### [35] [The JADES Transient Survey II: Volumetric Supernova Rates out to z~5](https://arxiv.org/abs/2607.12018)
...
### [36] [Galaxy mergers drive enhancements in ionization states](https://arxiv.org/abs/2607.12024)
...
### [37] [The JADES Transient Survey III: Linking Core-Collapse Supernova Rates to Cosmic Star Formation](https://arxiv.org/abs/2607.12028)
...
### [38] [Determination of kinematic distances of WISE & SMGPS H II regions in the Galactic plane using SEDIGISM cloud association](https://arxiv.org/abs/2607.12046)
...
### [39] [Tracing cosmic star formation history through radio continuum spectral energy distribution and non-thermal emission](https://arxiv.org/abs/2607.12073)
...
### [40] [Illuminating M82: Simulating X-ray Emission from Galactic Winds in a Starburst Galaxy](https://arxiv.org/abs/2607.12087)
...
### [41] [Discovery of a gravitational arc candidate at photometric redshift 4.4 in MACS J0308.9+2645 from a catalogue-based search of JWST imaging](https://arxiv.org/abs/2607.12129)
...
### [42] [A differentiable hydrodynamical approach to the Milky Way bar pattern speed with CO longitude--velocity data](https://arxiv.org/abs/2607.12146)
...
### [43] [Testing the recovery of the NGC 6505 Einstein ring in deep OSN 1.5-m imaging](https://arxiv.org/abs/2607.12209)
...
### [44] [Environmental Imprints on the Assembly of the Cool Gas around Bright Cluster Galaxies](https://arxiv.org/abs/2607.12361)
...
### [45] [A FLASH HI absorption search in compact sources in the pilot ASKAP interplanetary scintillation field](https://arxiv.org/abs/2607.12377)
...
### [46] [Bridging the mass gap: Diffuse radio emission in GAMA galaxy groups using EMU and DINGO survey data](https://arxiv.org/abs/2607.12434)
...
### [47] [Accretion-disk formation around orbiting stellar black holes in gaseous star clusters](https://arxiv.org/abs/2607.12465)
*Zacharias Roupas*
...
### [48] [The Three Hundred project: Low Gas Fraction Clusters properties and their environment](https://arxiv.org/abs/2607.12607)
...
### [49] [Discovery of a star sensitive to the spin of Sgr A*](https://arxiv.org/abs/2607.12664)
...
### [50] [Tidal Grinding of Dwarf Galaxies in Cluster Environments](https://arxiv.org/abs/2607.12694)
...
### [51] [Radar-Chart Analysis of Star-Formation Quenching Stages Across Circular Velocity Curve Classes in Nearby CALIFA Galaxies](https://arxiv.org/abs/2607.12701)
...
### [52] [Perturber-Driven Dynamics of Supermassive Black Hole Binaries in Galaxy Merger](https://arxiv.org/abs/2607.12708)
...
### [53] [The MAGPI survey: Stellar populations radial trends and mass assembly in star-forming galaxies at z~0.3](https://arxiv.org/abs/2607.12929)
...
### [54] [SMA Observations of the Archetypal Compact Steep-spectrum Radio Source 3C 303.1](https://arxiv.org/abs/2607.12952)
...
### [55] [Dynamical modelling of giant radio quasars in the HETDEX Spring Field](https://arxiv.org/abs/2607.12964)
...
### [56] [Alignment of the Milky Way and M31 with their cosmic environment. New insights from constrained Local Group simulations](https://arxiv.org/abs/2607.13005)
