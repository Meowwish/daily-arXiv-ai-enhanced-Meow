...
### [1] [Deuterium-Proton Fusion in an Effective Field Theory Constructed from On-Shell Amplitudes](https://arxiv.org/abs/2607.05514)
*Tim M. P. Tait*
...
### [2] [Multi-Wavelength Signatures of a Giant Cometary Radio Halo in MACSJ0417-1154](https://arxiv.org/abs/2607.07750)
...
### [3] [Causal Horizons, Geodesic Completeness and Stability in Slow Contraction Cosmology](https://arxiv.org/abs/2607.07815)
...
### [4] [Stellar J-Harvesting: a novel angular momentum technosignature and first search in the Kepler field](https://arxiv.org/abs/2607.07781)
*Sahin Torlakcik*
...
### [5] [Infrared-enhanced Photometric Redshifts for the Dark Energy Survey Y6 Gold catalogue](https://arxiv.org/abs/2607.07771)
...
### [6] [The Status of Single Scalar Field Dark Energy](https://arxiv.org/abs/2607.07777)
...
### [7] [Intensity fluctuations of radio halo in galaxy cluster: Insights from power spectrum estimation](https://arxiv.org/abs/2607.07814)
...
### [8] [Multipolar structure of the local expansion rate from incomplete sky data](https://arxiv.org/abs/2607.07821)
...
### [9] [Alcock-Paczynski Blinding Scheme for the Ly-$α$ Forest Analysis](https://arxiv.org/abs/2607.07875)
...
### [10] [Phantom crossing from the Standard Model and General Relativity](https://arxiv.org/abs/2607.08120)
...
### [11] [Lambda as a Probe of Lensing Consistency](https://arxiv.org/abs/2607.08286)
...
### [12] [A semi-analytical approach to cosmic void evolution](https://arxiv.org/abs/2607.08414)
...
### [13] [HETDEX [OII] galaxies at $z \le 0.48$: Volume-limited samples and their power spectra](https://arxiv.org/abs/2607.08453)
...
### [14] [XShooter DESI Lens Program: Sample characterization](https://arxiv.org/abs/2607.08562)
...
### [15] [Beyond ΛCDM with the SKA Observatory -- II: Unveiling the Secrets of the Early Universe](https://arxiv.org/abs/2607.08593)
...
### [16] [The Three Hundred Project: validating $H_0$ inference from mock X-ray and millimetre analyses of galaxy clusters](https://arxiv.org/abs/2607.08613)
...
### [17] [Can Distance Duality Violation Save Late-time Solutions to the Hubble Tension?](https://arxiv.org/abs/2607.08654)
...
### [18] [The statistics of curvature-profile dispersion in primordial black hole formation](https://arxiv.org/abs/2607.08738)
*Albert Escrivà*
...
### [19] [Multipolar Dark Matter Freeze-out in an Early Matter-Dominated Universe](https://arxiv.org/abs/2607.07956)
...
### [20] [Probing Quadratically Coupled Ultralight Dark Matter with the Laser Interferometer Space Antenna](https://arxiv.org/abs/2607.08248)
...
### [23] [Supersonic Motion in the Driving Region of M82](https://arxiv.org/abs/2607.07782)
...
### [24] [Probing the origins. III. Exoplanet demographics across Galactic birth radii](https://arxiv.org/abs/2607.07787)
...
### [25] [Tracing black hole and galaxy growth across environments since cosmic noon](https://arxiv.org/abs/2607.07793)
...
### [26] [The incidence of eROSITA X-ray AGN in the local Universe: from dwarf to massive galaxies](https://arxiv.org/abs/2607.07795)
...
### [27] [Boötes III is a Tidally Disrupting Ultra-Faint Dwarf Galaxy on an Eccentric Polar Orbit](https://arxiv.org/abs/2607.07803)
...
### [28] [Scaling Relations for Binary Black Hole Merger Times from Cosmological Initial Conditions](https://arxiv.org/abs/2607.07813)
...
### [29] [The DESI View of the Faint Radio Source Population in LoTSS DR2](https://arxiv.org/abs/2607.07818)
...
### [30] [On the detection of Population III galaxies: Emission Line Diagnostics for Hybrid Stellar Populations](https://arxiv.org/abs/2607.07832)
...
### [31] [Enhancing Photometric Redshift Estimation for LSST with a Hybrid LSTM-Mixture Density Network](https://arxiv.org/abs/2607.07960)
...
### [32] [There is no single density: star-forming regions and galaxies hold more dense ionized gas than long assumed](https://arxiv.org/abs/2607.07973)
...
### [33] [CARPP: Parametric Radiative-Transfer Fitting of Molecular Cores from Dust Continuum Data](https://arxiv.org/abs/2607.08192)
...
### [34] [Subaru meets JWST: A Direct Measurement of Ly$\boldsymbolα$ Escape Fraction at $\boldsymbol{z\simeq6.2}$ with Dual Narrow-Band Imaging](https://arxiv.org/abs/2607.08264)
...
### [35] [Milky Way Near Twins (MWNeTs). I. A Hierarchical Framework for Identifying the Evolutionary Counterparts of the Milky Way](https://arxiv.org/abs/2607.08336)
...
### [36] [Multiple populations along the asymptotic giant branch: a Gaia+APOGEE study of 22 Galactic globular clusters](https://arxiv.org/abs/2607.08376)
...
### [37] [Effects of low resolution on the column density PDF of molecular clouds](https://arxiv.org/abs/2607.08419)
...
### [38] [Constraints on the properties of warm ionized gas from low-frequency hydrogen radio recombination lines](https://arxiv.org/abs/2607.08542)
...
### [39] [Disentangling the dark and stellar mass through precise lens modelling of the JWST observation of lensed quasar WFI2033--4723](https://arxiv.org/abs/2607.08576)
...
### [40] [Classification of blazars based on data-driven approaches](https://arxiv.org/abs/2607.08594)
...
### [41] [VAPOLA -- A multi-year, multi-band polarization survey of AGN and Sgr A* at mm wavelengths with ALMA I. Survey Overview and Science-Ready Archival Products](https://arxiv.org/abs/2607.08657)
...
### [42] [Detection of the Polycyclic Aromatic Hydrocarbon Phenalene (C$_{13}$H$_{10}$) in the Very Low Luminosity Object (VeLLO) MC27/L1521F](https://arxiv.org/abs/2607.08699)
...
### [43] [Thermal Sunyaev-Zel'dovich Measurements of Locally Bright Galaxies with ACT DR6: Radio Source Contamination and Excess Compton-y Signal](https://arxiv.org/abs/2607.08721)
...
### [44] [Force convergence in Monte Carlo Lyman-alpha radiative transfer](https://arxiv.org/abs/2607.08726)
...
### [45] [Deep Spectroscopic Follow-Up of Maisie's Galaxy -- A Typical Galaxy in the Early Universe](https://arxiv.org/abs/2607.08749)
