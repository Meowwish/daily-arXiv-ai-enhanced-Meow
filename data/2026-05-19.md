...
### [3] [The bound origin of low-mass stellar binaries](https://arxiv.org/abs/2605.16657)
...
### [4] [7DT Insight: Variability in Young Stellar Objects](https://arxiv.org/abs/2605.18366)
...
### [5] [Modifications of CMB Temperature and Polarization Quadrupole Signals in Thurston Spacetimes](https://arxiv.org/abs/2605.14572)
...
### [6] [Constraints on non-canonical chaotic inflation from ACT DR6 and BICEP/Keck data](https://arxiv.org/abs/2605.16772)
...
### [7] [Gauge-invariant cosmological perturbations in Type 3 New General Relativity and background-hierarchy bounds](https://arxiv.org/abs/2605.16869)
...
### [8] [Warm inflation in Weyl geometric gravity](https://arxiv.org/abs/2605.16884)
...
### [9] [Positive Running of the Spectral Index for Scalar Theory and Modified Gravity](https://arxiv.org/abs/2605.17813)
...
### [10] [Cosmological perturbations of TDiff fields](https://arxiv.org/abs/2605.18424)
...
### [11] [The limits of feedback from active galactic nuclei](https://arxiv.org/abs/2605.16483)
...
### [12] [Co-evolution of Supermassive Black Holes and their Host L* galaxies: implications for Milky Way and M31](https://arxiv.org/abs/2605.16501)
...
### [13] [Feedback driven interactions between dark and luminous matter to explain tight galaxy scaling relations](https://arxiv.org/abs/2605.16505)
...
### [14] [The Rapid ASKAP Continuum Survey VII: Spectra and Polarisation In Cutouts of Extragalactic Sources (SPICE-RACS) Second Data Release -- Unveiling the Magnetised Sky](https://arxiv.org/abs/2605.16917)
...
### [15] [Magnetised CGM Gas at z~1 revealed by SPICE-RACS](https://arxiv.org/abs/2605.16924)
...
### [16] [Determination of the best dark matter profile for the Milky Way with Gaia DR3 using Bayesian Model Comparison](https://arxiv.org/abs/2605.16994)
...
### [17] [The ${}^{13}\mathrm{CO}(2{-}1)/^{12}\mathrm{CO}(2{-}1)$ Line Ratio from 100 Molecular Clouds in the Large Magellanic Cloud](https://arxiv.org/abs/2605.17024)
...
### [18] [PEARLS: JWST Counterparts of Micro-Jy Radio Sources in the NEP Time Domain Field. II. All Four Spokes](https://arxiv.org/abs/2605.17040)
...
### [19] [HI Observations of Baryon-Dominated Dwarf Galaxy Candidates](https://arxiv.org/abs/2605.17253)
...
### [20] [From inter-filamentary gas to filaments and hubs: gas flows in the Mon R2 hub-filament system](https://arxiv.org/abs/2605.17372)
...
### [21] [BISTRO Survey: Gravity-Dominated and Magnetically Regulated Star Formation in M17 SW](https://arxiv.org/abs/2605.17708)
...
### [22] [Nuclear Activity and Host Galaxy Properties of Low-Luminosity AGN Identified from VLA Observations](https://arxiv.org/abs/2605.17993)
*M. N. Rosli,A. Annuar*
...
### [23] [SDSS-V: Revealing a weak accretion state in X-ray selected red quasars](https://arxiv.org/abs/2605.18161)
...
### [24] [Polarization Observations of a Sample of 6.7 GHz Methanol Masers](https://arxiv.org/abs/2605.18275)
...
### [25] [Constraining the magnetic field strength of a flaring radio core in the compact steep spectrum source 3C 138](https://arxiv.org/abs/2605.18283)
...
### [26] [Velocity-resolved [O I] 63,145 um, [C II] 158 um, and OH line mapping along the Orion BN/KL explosive outflow and irradiated shocks](https://arxiv.org/abs/2605.18438)
...
### [27] [CCD () photometry of the open cluster NGC 6793 and its dynamical evolution](https://arxiv.org/abs/2605.18665)
...
### [28] [Expected redshift drift for tilted observers](https://arxiv.org/abs/2605.16426)
...
### [29] [Thermostats, Not Engines: A New Picture of Halo Gas Regulation](https://arxiv.org/abs/2605.16488)
...
### [30] [Modeling the probability distribution for cosmological analysis with photometrically classified samples](https://arxiv.org/abs/2605.16513)
...
### [31] [Circular polarization of the cosmic microwave background induced by the optical Magnus effect on gravitational lensing](https://arxiv.org/abs/2605.16945)
*Yusuke Nishida*
...
### [32] [Constraints on Self-Interacting Fuzzy Dark Matter from the Stellar Kinematics of the Dwarf Galaxy Leo II](https://arxiv.org/abs/2605.17211)
...
### [33] [Coupled quintessence with a potential from supergravity exhibits sign-changing interaction](https://arxiv.org/abs/2605.17754)
...
### [34] [Gravitational lensing time delay beyond the Shapiro/geometry split](https://arxiv.org/abs/2605.18182)
...
### [35] [Quadratic Dark Energy Phase-Space Dynamics and Analysis](https://arxiv.org/abs/2605.18240)
...
### [36] [Primary gravitational waves at high frequencies II: Emergence of the exponential cut-off in the power spectrum](https://arxiv.org/abs/2605.18286)
...
### [37] [Probing Reionization up to the Mark: The Marked Power Spectrum to unveil the HI 21-cm signal from the EoR](https://arxiv.org/abs/2605.18301)
...
### [38] [(An)Isotropy in Pantheon+ and Type Ia supernova samples: intrinsic limits of directional tests](https://arxiv.org/abs/2605.18470)
...
### [39] [Primordial power spectrum reconstructions from BOSS + eBOSS](https://arxiv.org/abs/2605.18615)
...
### [40] [Faster CMB lensing with control variates](https://arxiv.org/abs/2605.18659)
...
### [41] [Recoupled Dark Radiation reconciling CMB and DESI BAO measurements](https://arxiv.org/abs/2605.18716)
...
### [42] [The EDGES Analysis Pipeline: Description and Validation](https://arxiv.org/abs/2605.16643)
...
### [43] [Extracting redshifts from 2D slitless spectroscopic images using deep learning for the CSST galaxy survey](https://arxiv.org/abs/2605.16762)
...
### [44] [Accelerating Redshift-Conditioned Galaxy Image Synthesis with One-step Generative Modeling](https://arxiv.org/abs/2605.17546)
...
### [45] [Photometric classification of quasars from DES and photo-$z$ estimation with Machine Learning](https://arxiv.org/abs/2605.18218)
...
### [46] [The pair-instability origin of supernova 2023vbw](https://arxiv.org/abs/2605.16487)
...
### [47] [Is the Binary Black Hole Population Inference from Gravitational-Wave Data Robust?](https://arxiv.org/abs/2605.16510)
...
### [48] [Population synthesis of active galactic nuclei based on the radiation-regulated unification model](https://arxiv.org/abs/2605.17547)
...
### [49] [Higher-order statistics of the stochastic gravitational wave background from supermassive black hole binaries](https://arxiv.org/abs/2605.17983)
...
### [51] [The First Remotely Detected Biosignature May Not Be the Most Common: Implications for JWST and HWO](https://arxiv.org/abs/2605.16674)
*Ravi Kopparapu*
...
### [52] [Systematic KMTNet Planetary Anomaly Search. XIII. Complete Sample of 2021 Prime Field Planets](https://arxiv.org/abs/2605.17053)
...
### [53] [Chemistry and IR emission of acetylene in planet-forming regions of T Tauri disks. Impact of elemental abundances and dust properties](https://arxiv.org/abs/2605.18062)
...
### [54] [Inferring stellar metallicity and elemental abundances from kinematic and spectroscopic data using machine learning -- Implications for exoplanet host stars](https://arxiv.org/abs/2605.18131)
