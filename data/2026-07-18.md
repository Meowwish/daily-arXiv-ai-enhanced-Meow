...
### [1] [Thermal Masses and Bubble-Wall Friction in Cosmological Phase Transitions](https://arxiv.org/abs/2607.14867)
...
### [2] [Particle production from bubble collisions](https://arxiv.org/abs/2607.15279)
...
### [3] [Chemodynamical evidence of the HR 1614 moving group as a bar resonance](https://arxiv.org/abs/2607.14224)
...
### [4] [Efficient Interstellar Grain Growth from High Sticking Coefficients on Amorphous Carbon Dust](https://arxiv.org/abs/2607.14237)
...
### [5] [VENUS: an ultra-faint galaxy hosting the metal-poor type II supernova at $z=5.13$ Witnessing the initial metal enrichment with extremely frequent core-collapse supernovae?](https://arxiv.org/abs/2607.14355)
...
### [6] [The chemodynamical signature of coherent metal-poor inflow and enriched recycled accretion in the cool circumgalactic medium](https://arxiv.org/abs/2607.14359)
...
### [7] [Merging galaxies and clusters: Insights into the role of magnetic fields and the physics of radio relics](https://arxiv.org/abs/2607.14426)
*Joseph Whittingham*
...
### [8] [Accurate proper motions of the protostellar system VLA1623-2417](https://arxiv.org/abs/2607.14428)
...
### [9] [Revisiting Data Quality Control and Multiple-star Modeling in Wide Binary Gravity Tests: Confirmation of MOND-type Gravitational Anomaly at Low Acceleration](https://arxiv.org/abs/2607.14450)
...
### [10] [Features of the distribution of absorbing matter in the local system](https://arxiv.org/abs/2607.14551)
...
### [11] [A Catalog of Compact High-Velocity Clouds from the FAST All-Sky HI Survey (FASHI) DR2](https://arxiv.org/abs/2607.14584)
...
### [12] [Relativistic Tidal Transitions of Saturated Kerr Boson Clouds](https://arxiv.org/abs/2607.14627)
*Yi-kun Li*
...
### [13] [The Mysterious Case of Iron in XMPs: Anomalous High log(Fe/O) Observed in Extremely Metal-Poor Galaxies HSCJ1631+4426 and SDSSJ0811+4730](https://arxiv.org/abs/2607.14758)
...
### [14] [Enabling Cosmic Web Analysis at Gigaparsec Scales: A Multi Block Approach for DisPerSE](https://arxiv.org/abs/2607.14785)
...
### [15] [Fuelling the central region of galaxies with misaligned gas accretion](https://arxiv.org/abs/2607.14823)
...
### [16] [Discrepancies between Chandrasekhar's theory of relaxation and $N$-body simulations](https://arxiv.org/abs/2607.14844)
...
### [17] [The COLIBRE-SKIRT pipeline: Calibration-free dust radiative transfer postprocessing for cosmological simulations](https://arxiv.org/abs/2607.14901)
...
### [18] [The Goldilocks Molecule: H$_{2}$ Emission Lines Can Identify Elusive Dwarf AGN](https://arxiv.org/abs/2607.14971)
...
### [19] [Isomer-specific excitation of formic acid in collisions with helium atoms](https://arxiv.org/abs/2607.14985)
...
### [20] [The World Cup in space: Finding ionised buckyballs in the ISM with CARMENES](https://arxiv.org/abs/2607.15002)
*J. Maíz Apellániz*
...
### [21] [Berkeley 32: A Metal-poor and Dynamically Evolved Open Cluster with Evidence of Radial Migration](https://arxiv.org/abs/2607.15131)
...
### [22] [Cluster characteristics of Galactic open clusters](https://arxiv.org/abs/2607.15149)
...
### [23] [Cosmological Collider Signals at Strong Mixing](https://arxiv.org/abs/2607.14891)
...
### [24] [Dust masses of Upper Scorpius disks and their statistics](https://arxiv.org/abs/2607.14850)
...
### [25] [Testing the Isotropy of the Universe with the CHIME/FRB Catalog I](https://arxiv.org/abs/2607.14982)
...
### [26] [The Open Cluster Chemical Abundances and Mapping Survey: IX. Measuring the Effects of Stellar Diffusion in the Open Clusters NGC 752 and Ruprecht 147 using APOGEE](https://arxiv.org/abs/2607.14208)
...
### [27] [Runaway OB stars within 1 kpc of the Sun](https://arxiv.org/abs/2607.14633)
...
### [28] [Stellar Multiplicity in Open Clusters: Investigating Binary Fractions and Their Relationship with Cluster Properties](https://arxiv.org/abs/2607.14987)
...
### [29] [The non-LTE abundances of magnesium and yttrium and asteroseismic ages for the chemical clock calibration](https://arxiv.org/abs/2607.15017)
...
### [30] [Comment on "Non-linear interactions in cosmologies with energy exchange"](https://arxiv.org/abs/2607.15012)
*Naman Soni*
...
### [31] [Simulation-Based Priors for HI Bias from Halo Occupation Physics](https://arxiv.org/abs/2607.14206)
...
### [32] [Measuring satellite galaxy subhalo masses in redMaPPer clusters with UNIONS weak lensing data](https://arxiv.org/abs/2607.14207)
...
### [33] [The topology of the magnetic field in Abell 2255 out to its virial radius. Results from the LOFAR Galaxy Cluster Ultra-Deep Field](https://arxiv.org/abs/2607.14209)
...
### [34] [Non-Primordial Contribution to the Cosmic Microwave Background](https://arxiv.org/abs/2607.14211)
...
### [35] [Charting the expansion of the Universe from z$\sim$0 to z$\sim$14 with HII galaxies](https://arxiv.org/abs/2607.14254)
...
### [36] [Misalignment production of isotropized vector dark matter?](https://arxiv.org/abs/2607.14267)
*Chong-Bin Chen*
...
### [37] [Cosmological $γ$-$γ$ Pair-Production Background](https://arxiv.org/abs/2607.14276)
...
### [38] [The plethora of diffuse emission in Abell 2034 as revealed by MeerKAT polarization observations](https://arxiv.org/abs/2607.14347)
...
### [39] [Probabilistic redshift estimation of unresolved galaxies from multi-band background light maps](https://arxiv.org/abs/2607.14525)
...
### [40] [Pushing the Primordial Frontier: Cosmological Collider Signatures at Strong Mixing](https://arxiv.org/abs/2607.14529)
...
### [41] [Probing Graviton Mass with MeerKAT PTA and SKA--PTA Forecasts](https://arxiv.org/abs/2607.14790)
...
### [42] [Analytical covariances for catalogue-based pseudo-$C_\ell$s](https://arxiv.org/abs/2607.14843)
...
### [43] [CAMB v2: cosmological power spectra for high-precision surveys](https://arxiv.org/abs/2607.14854)
*Antony Lewis*
...
### [44] [The VST ATLAS Survey -- IV: Galaxy, LRG and QSO bias and HODs via ACT CMB Lensing](https://arxiv.org/abs/2607.14904)
...
### [45] [High resolution Lyman-α forest constraints on dark matter-neutrino scattering](https://arxiv.org/abs/2607.15020)
...
### [46] [Refining primordial black hole dark matter constraints with dust heating: the role of spin and halo profile dependence](https://arxiv.org/abs/2607.15028)
...
### [47] [Cosmic string gravitational wave backgrounds at LISA: II. Reconstruction of conventional signals over astrophysical foregrounds](https://arxiv.org/abs/2607.15219)
