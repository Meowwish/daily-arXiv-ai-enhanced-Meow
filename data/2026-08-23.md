...
### [1] [Stochastic Schwinger Effect: de Sitter and beyond](https://arxiv.org/abs/2608.19378)
...
### [2] [Early Planet Formation in Embedded Disks (eDisk). XXIV: Systematic Investigation of Disk Structures based on Visibility Analysis](https://arxiv.org/abs/2608.19364)
...
### [7] [Bayesian Forecasts on Cosmic Superstring Searches with LISA](https://arxiv.org/abs/2608.19406)
...
### [8] [WIMP Freeze-Out in Diffusive Unimodular Gravity](https://arxiv.org/abs/2608.19482)
...
### [9] [The THESAN-ZOOM project: clumpiness of high-redshift galaxies and its connection to bursty star formation](https://arxiv.org/abs/2608.19308)
...
### [18] [OutThere Survey: Addressing $\mathrm{ξ_{ion}}$ and $\mathrm{f_{esc}}$ with a population of average galaxies at z$\sim$2](https://arxiv.org/abs/2608.19687)
...
### [19] [ALOHA IRDCs Molecular Line Follow-up: I. Gas properties and kinematics](https://arxiv.org/abs/2608.20238)
...
### [23] [Imaging the vacuum fluctuations of a quantum field](https://arxiv.org/abs/2608.20311)
...
### [24] [The Cross-Survey Decade: A Call to Action](https://arxiv.org/abs/2608.19272)
...
### [25] [Towards independent event horizon imaging of the supermassive black holes in M87 and the Milky Way](https://arxiv.org/abs/2608.19675)
...
### [26] [Microlensify: a Transformer Based Machine Learning Classifier for Microlensing Events Trained on TESS Light Curves](https://arxiv.org/abs/2608.19419)
...
### [27] [The SPT-3G+ receiver design](https://arxiv.org/abs/2608.20235)
...
### [28] [The Challenge of Observing Patchy Reionization with CMB Optical-Depth Fluctuations](https://arxiv.org/abs/2608.19307)
...
### [29] [Does Early Dark Energy Absorb the DESI Late-Time Dynamics Signal? A Combined Analysis](https://arxiv.org/abs/2608.19432)
...
### [30] [Cluster finding with outskirt stellar masses and percolation](https://arxiv.org/abs/2608.19768)
...
### [31] [Quintessential α-attractors, updated](https://arxiv.org/abs/2608.19781)
...
### [32] [A Prediction for DESI Full-Shape: Increasing Tomographic $Ω_m(z)$ Trend](https://arxiv.org/abs/2608.19883)
...
### [33] [Non-minimal Unimodular Inflation](https://arxiv.org/abs/2608.20095)
...
### [34] [Testing Statistical Isotropy in the FRB Sky Distribution: A Selection-Function-Aware Framework](https://arxiv.org/abs/2608.20135)
...
### [35] [Inflation on the lattice: scalar Gauss-Bonnet single field inflation](https://arxiv.org/abs/2608.20219)
...
### [36] [SPT-3G+: A Cosmic Microwave Background Experiment for the South Pole Telescope](https://arxiv.org/abs/2608.20236)
...
### [37] [Transient Early Dark Energy-Like Dynamics as a Mechanism for Enhanced Early Structure Formation in the JWST Era](https://arxiv.org/abs/2608.20288)
...
### [38] [Non-Minimally Coupled Warm Inflation in the Defining Frame](https://arxiv.org/abs/2608.20293)
...
### [39] [A blind spot in transverse BAO calibration](https://arxiv.org/abs/2608.20296)
*Domenico Sapone*
...
### [40] [Modeling Relativistic Tidal Disruptions of MESA Stars](https://arxiv.org/abs/2608.19402)
...
### [41] [Quasi-periodic Eruptions from Recurrent Satellite Black Hole Transits through Magnetized Galactic Nucleus Accretion Disks](https://arxiv.org/abs/2608.19796)
...
### [42] [How Inflation Might Explain Large-Scale Anisotropy](https://arxiv.org/abs/2608.19765)
*Brett McInnes*
