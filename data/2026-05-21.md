...
### [16] [Detection of a dark matter subhalo in the strongly lensed system PJ011646](https://arxiv.org/abs/2605.21212)
...
### [17] [B-Fields and Star Formation across Scales with TRAO (B-FROST): CO Abundances, Dynamics and Relative Orientations in the Translucent High Latitude Cloud MBM12](https://arxiv.org/abs/2605.21101)
...
### [19] [The Highly Variable Wind from WD J005311, the Stellar Remnant of the Peculiar Galactic Supernova of 1181](https://arxiv.org/abs/2605.20360)
...
### [20] [The \emph{R}-process Alliance: A Bright, Strongly \emph{R}-process-enhanced Extremely Metal-poor Star Observed with GHOST](https://arxiv.org/abs/2605.20614)
...
### [21] [Multi-diagnostic convergence: a single measurement in weakly collisional plasmas](https://arxiv.org/abs/2605.21106)
*Victor Edmonds*
...
### [24] [Audible Axion Magnetogenesis: Linking Intergalactic Magnetic Fields and Gravitational Waves](https://arxiv.org/abs/2605.21092)
...
### [25] [Self-Consistent Parker Bound on Magnetic Monopoles](https://arxiv.org/abs/2605.21281)
...
### [26] [Cosmological Collider Signatures from Right-Handed Neutrino Loop](https://arxiv.org/abs/2605.21419)
...
### [27] [Gravitational Waves from Black Hole Reheating: The Scalar-Induced Component](https://arxiv.org/abs/2605.21474)
...
### [28] [Opening the Window of Ultra-Light PBHs by Exorcising the Poltergeist](https://arxiv.org/abs/2605.21477)
*Yann Gouttenoire,Nicholas Leister,Pedro Schwaller*
...
### [29] [On the Possibility of an Extragalactic Positron Annihilation Signal](https://arxiv.org/abs/2605.21289)
...
### [30] [On the origin of anomalous dissipation in simulations of tidal disruption events](https://arxiv.org/abs/2605.20327)
...
### [31] [Thermal Structure and Chemical Enrichment of the North and South Polar Spurs: Supersolar N/O and Ne/O in the X-ray Plasma](https://arxiv.org/abs/2605.20335)
...
### [32] [Characterizing the origins of gamma-ray variability of the jetted active galactic nuclei observed with the Fermi-LAT](https://arxiv.org/abs/2605.20843)
...
### [33] [FR0 radio galaxy jets -- I. linking jet dynamics and high-energy emission in LEDA 55267 and LEDA 58287](https://arxiv.org/abs/2605.21320)
...
### [34] [Contrastive self-supervised convolutional autoencoder for core-collapse supernova gravitational-wave detection](https://arxiv.org/abs/2605.21310)
...
### [35] [Effective Field Theory for a Baryon-Correlated Dark Matter Profile](https://arxiv.org/abs/2605.20217)
*Kento Kamada*
...
### [36] [Cosmological perturbations with $f(R)$ gravity scalarons : Galaxy power spectra and the scalaron mass](https://arxiv.org/abs/2605.20227)
...
### [37] [CMB Acoustic Power Spectra in STVG-MOG](https://arxiv.org/abs/2605.20231)
*John W. Moffat*
...
### [38] [The Splashback Mass Function of Galaxy Clusters from Photometric Data](https://arxiv.org/abs/2605.20393)
...
### [39] [Probing late-time deviations from $Λ$CDM with a quadratic dark energy expansion](https://arxiv.org/abs/2605.20748)
...
### [40] [Reconstruction of Reionization Histories from 21 cm Power-Spectrum Evolution with Artificial Neural Networks](https://arxiv.org/abs/2605.21012)
...
### [41] [CosmoForge I: A unified framework for QML power spectrum estimation and pixel-based likelihood analysis](https://arxiv.org/abs/2605.21149)
...
### [42] [Euclid preparation: Testing multi-field inflation with galaxy power spectrum and bispectrum](https://arxiv.org/abs/2605.21436)
...
### [43] [Negative neutrino mass or negative dark energy?](https://arxiv.org/abs/2605.21456)
...
### [44] [Velocityformer: Broken-Symmetry-Matched Equivariant Graph Transformers for Cosmological Velocity Reconstruction](https://arxiv.org/abs/2605.21483)
