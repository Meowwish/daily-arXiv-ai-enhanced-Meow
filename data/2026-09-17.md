...
### [1] [Unifying spatial correlation with hierarchical population inference to constrain the AGN channel for binary black hole mergers](https://arxiv.org/abs/2609.17665)
...
### [2] [Uncovering New Ionized Winds and Relativistic Hot Outflows in MCG-6-30-15 with \emph{Chandra} HETG and a Bayesian Framework](https://arxiv.org/abs/2609.17723)
...
### [3] [Radiation Magneto-hydrodynamic Simulations of MRI with Zero-Net-Vertical-Flux: Necessity of Resolving the Thermal Scale For Strongly Magnetized Initial Conditions](https://arxiv.org/abs/2609.17813)
...
### [4] [RadioAstron space-VLBI imaging of the jet in M87: II. The parsec-scale structure at 4.8 GHz](https://arxiv.org/abs/2609.18192)
...
### [5] [Studying the Intermittency of Magnetized Interstellar Medium by Synchrotron Polarization Intensity and its Gradient](https://arxiv.org/abs/2609.18699)
...
### [6] [Gravitating sources with zero energy density in cosmology](https://arxiv.org/abs/2609.17604)
...
### [7] [Massively parallel transdimensional sampling with data assimilation: an application to LISA galactic binaries](https://arxiv.org/abs/2609.17674)
...
### [8] [Observationally Reconstructed Spacetime of NGC 5907: Dark-Matter-Corrected Black Hole Thermodynamics and Galactic Shadow](https://arxiv.org/abs/2609.17570)
...
### [10] [The galaxy--electron cross-spectrum with ACT, SPT-3G and DESILS LRGs](https://arxiv.org/abs/2609.17676)
*Selim C. Hotinli*
...
### [11] [A reanalysis of the megamaser Hubble constant: from spot catalogues to peculiar velocities](https://arxiv.org/abs/2609.17684)
...
### [12] [On the cosmic previrialization](https://arxiv.org/abs/2609.17805)
...
### [13] [Resolving 3 Exotic Hyperbolic-Umbilic Lensing Configurations in the "Cosmic Mantis": An Exploration of RXJ0437.1+0043 with JWST](https://arxiv.org/abs/2609.17852)
...
### [14] [Infrared Universality of Scalar Induced Gravitational Waves Beyond Second Order](https://arxiv.org/abs/2609.17928)
*Chen Yuan*
...
### [15] [Constraints of Big Bang Nucleosynthesis and Cosmological Observations on varying Higgs VEV](https://arxiv.org/abs/2609.18168)
...
### [16] [Void probability function in the Quijote simulations](https://arxiv.org/abs/2609.18221)
...
### [17] [Cosmological anatomy of interacting dark energy](https://arxiv.org/abs/2609.18288)
...
### [18] [Follow-up of SN 2025wny VI: The Rate and Detectable Population of Strongly Lensed SLSNe-I in ZTF](https://arxiv.org/abs/2609.18912)
...
### [19] [The Solar Neighborhood LVI: The RMSTAR Catalog of the Nearest 3352 M Dwarf Systems and 305 of their Wide Companions](https://arxiv.org/abs/2609.17729)
...
### [20] [Proto-Planetary Nebulae Are Not the Precursors of Planetary Nebulae With Close Binary Central Stars](https://arxiv.org/abs/2609.17830)
...
### [21] [A large shell around the hypergiant VY Canis Majoris](https://arxiv.org/abs/2609.18895)
...
### [22] [The OpenGadget3 Code for Cosmological Simulations](https://arxiv.org/abs/2609.17658)
...
### [23] [Optimising instrument concepts with Machine Learning: Application to CMB spectral distortion experiments](https://arxiv.org/abs/2609.17829)
...
### [24] [IViS: Interferometric Visibility-domain inversion Software - A GPU-accelerated Python framework for joint deconvolution with ASKAP](https://arxiv.org/abs/2609.17636)
...
### [25] [Pulsed ion deflection to overcome detector saturation in cryogenic ice sampling](https://arxiv.org/abs/2609.17873)
...
### [26] [Quantifying the temperature-dependent yields of N$_2$ and N$_2$H$_4$ formation in vacuum-ultraviolet-irradiated NH$_3$ ice](https://arxiv.org/abs/2609.17878)
...
### [27] [Proper Time Shifts in Pulsar Timing Arrays](https://arxiv.org/abs/2609.17668)
*Vincent S. H. Lee*
...
### [28] [WIMPs with Enhanced Annihilation from a Feebly Interacting Unstable Partner](https://arxiv.org/abs/2609.17672)
...
### [29] [Probing Lorentz-violating scalar forces and dark matter with precision matter and antimatter experiments](https://arxiv.org/abs/2609.18263)
*Yevgeny V. Stadnik*
...
### [30] [Reheating Bounds from Thermal GUT Monopole Production](https://arxiv.org/abs/2609.18596)
...
### [31] [The relationship between morphology, density, and location in the cosmic web from massive to dwarf galaxies](https://arxiv.org/abs/2609.17662)
...
### [32] [On the clumpy nature of super-early galaxies](https://arxiv.org/abs/2609.17667)
...
### [33] [Chandra Lensing-cluster Ultradeep Extragalactic Survey (CLUES) I: A 2 Ms Point-Source Catalog of the Abell 2744 Field](https://arxiv.org/abs/2609.17673)
...
### [34] [A dense, metal-rich absorber driven by a heavily dust-obscured galaxy: The direct evidence of CGM enrichment at $z\sim7$](https://arxiv.org/abs/2609.17680)
...
### [35] [JADES: Dynamical Measurements of Dark Matter Halo Masses at $z \approx 7$ Using Galaxy Pairs](https://arxiv.org/abs/2609.17756)
...
### [36] [In situ characterization of volatile and refractory hydrocarbons produced by UV photolysis of interstellar C$_2$H$_2$ ice](https://arxiv.org/abs/2609.17867)
...
### [37] [Does galaxy-scale compactness regulate nebular electron density? A cross-scale test with DESI](https://arxiv.org/abs/2609.18000)
*Shihong Liu,Yu Rong*
...
### [38] [A Possible Hidden Hot Halo Component Revealed by Joint X-ray and Sunyaev--Zel'dovich Observations](https://arxiv.org/abs/2609.18006)
...
### [39] [A Detailed GASKAP-HI View of Shells and Loops in the Magellanic Bridge](https://arxiv.org/abs/2609.18160)
...
### [40] [Galaxy-Galaxy Strong Lensing simulation with the GPU acceleration across surveys and multi-bands](https://arxiv.org/abs/2609.18180)
...
### [41] [The Delegate Survey: KOALA/AAOmega-IFU spectroscopy of three nearby dwarf galaxies](https://arxiv.org/abs/2609.18319)
...
### [42] [Self-interacting dark matter delays bar growth in an isolated gas-rich galactic disk: torque-resolved numerical evidence](https://arxiv.org/abs/2609.18343)
*Dong-Biao kang*
...
### [43] [Low Star Formation Efficiency in M31: Evidence for a Deficit of Bound Gas](https://arxiv.org/abs/2609.18408)
...
### [44] [Challenging the archetypal intermittent radio galaxy J0111+3906. New insights from optical GTC/OSIRIS and radio VLA and LOFAR observations](https://arxiv.org/abs/2609.18543)
...
### [45] [Signatures of dark subhaloes in dwarf spheroidal galaxies: II. Transient and localised kinematic features](https://arxiv.org/abs/2609.18552)
...
### [46] [The Spitzer Data Fusion - A Far-Ultraviolet to Far-Infrared Multi-Wavelength Database in Spitzer Extragalactic Survey Fields](https://arxiv.org/abs/2609.18694)
*Mattia Vaccari*
...
### [47] [CNO in Giant Metal-Poor Stars](https://arxiv.org/abs/2609.18760)
*Jannat Alazzawi*
...
### [48] [CosmoDyn: a semi-analytic post-processing framework for the dynamical evolution of compact stellar systems and black holes in cosmological simulations](https://arxiv.org/abs/2609.18821)
...
### [49] [Rotational spectroscopy and astronomical search of propane-1-thiol (CH3CH2CH2SH) and propane-2-thiol ((CH3)2CHSH)](https://arxiv.org/abs/2609.18896)
...
### [50] [Massive Galaxy Halos Contain Less Inner Dark Matter Than Predicted](https://arxiv.org/abs/2609.19132)
...
### [51] [Alpha-Core Breakup in the Strong Decay of \({}_{ΛΛ}^{6}\mathrm{He}\) to a Deeply Bound \(H\) Dibaryon](https://arxiv.org/abs/2609.17117)
