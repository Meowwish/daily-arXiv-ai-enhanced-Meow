...
### [1] [Galaxy-cluster-stacked Fermi-LAT, part IV: $\sim70$ GeV WIMP annihilation lines](https://arxiv.org/abs/2606.17044)
*Uri Keshet*
...
### [2] [Revisiting Disk Winds in Active Galactic Nuclei as an Origin of Cosmic Gamma-ray and Neutrino Backgrounds](https://arxiv.org/abs/2606.17490)
...
### [3] [Effective description of lensed gravitational waves diffracted by stellar fields](https://arxiv.org/abs/2606.17765)
...
### [4] [A Semi-Analytical Loss Cone Theory for Tidal Disruption Event Rates Around Kerr Black Holes](https://arxiv.org/abs/2606.18050)
*Wenkang Xin*
...
### [5] [Direct Detection of Millicharged Particles from Supernovae](https://arxiv.org/abs/2606.11310)
...
### [6] [Freeze-in and ultra-relativistic freeze-out during general reheating scenarios](https://arxiv.org/abs/2606.17155)
*Kuldeep Deka*
...
### [7] [Fourier-Preconditioned Path Deformations for Multi-Field Vacuum Tunnelling](https://arxiv.org/abs/2606.17485)
...
### [8] [The flaring drill in the Galactic centre. Did the IRS 13 cluster carve out the mini-cavity in the mini-spiral?](https://arxiv.org/abs/2606.17131)
...
### [9] [Chemical enrichment of the Perseus cluster core seen by XRISM/Resolve](https://arxiv.org/abs/2606.17141)
...
### [10] [Decoupled Kinematics and Excitation in the Compton-thick AGN NGC 6552: Spatially Resolved KOOLS-IFU Observations](https://arxiv.org/abs/2606.17144)
...
### [11] [MEGA and SMILES Find Fewer Dusty Galaxies than Expected at Cosmic Noon](https://arxiv.org/abs/2606.17146)
...
### [12] [Hector Galaxy Survey: Optical IFU and Chandra Reveal a Low-Luminosity AGN Behind Extended LINER Emission](https://arxiv.org/abs/2606.17152)
...
### [13] [Chemical hints of Population III stars from silicon abundances in massive galaxies](https://arxiv.org/abs/2606.17153)
...
### [14] [Exploring the Relationship Between Bars, Star Formation Activity, and Host Galaxy Properties from $\mathbf{z \sim 0}$ to $\mathbf{z \sim 2}$](https://arxiv.org/abs/2606.17189)
...
### [15] [Testing masking effectiveness using multi-line image cubes based on COSMOS2020 for [CII] line intensity mapping at $z_{[CII]} > 3.5$](https://arxiv.org/abs/2606.17210)
...
### [16] [Dust-Embedded Star Formation: Bridging Magellanic Cloud Studies of Massive Young Stellar Objects to Nearby Spiral Galaxies](https://arxiv.org/abs/2606.17262)
...
### [17] [Dust in the Average Galaxy: Attenuation, Emission, and Opacity from 0<z<7](https://arxiv.org/abs/2606.17270)
...
### [18] [Black Hole Stars Across the Universe: Identifying Central Engine Dominated Little Red Dots at $z\sim1.5-9.5$](https://arxiv.org/abs/2606.17271)
...
### [19] [Reduced Effective Viscosity from Anisotropic Transport and Plasma Instabilities in the Sloshing Cores of Galaxy Clusters](https://arxiv.org/abs/2606.17371)
...
### [20] [The Incidence of Large Ionized Bubbles at Redshift 13](https://arxiv.org/abs/2606.17571)
...
### [22] [TOPoS VII. Age-metallicity relation in the Galactic halo and assembly of the Milky Way](https://arxiv.org/abs/2606.17674)
...
### [23] [Galaxy groups within voids](https://arxiv.org/abs/2606.17676)
...
### [24] [Tracing the very early disruption of the Sagittarius dwarf galaxy in the distant Milky Way halo](https://arxiv.org/abs/2606.17754)
...
### [25] [Variability in Cosmological Hydrodynamical Simulations: how Stochastic Processes, Numerical Effects, and Reproducibility Limits impact Predictability](https://arxiv.org/abs/2606.18082)
...
### [26] [The ultra-deep HI radial profiles of late-type galaxies from MHONGOOSE](https://arxiv.org/abs/2606.18104)
...
### [27] [An extreme ram-pressure stripping event in a protocluster at redshift 4.3](https://arxiv.org/abs/2606.18229)
...
### [28] [PAHSPECS: Polycyclic aromatic hydrocarbon properties at cosmic noon with JWST/MIRI MRS](https://arxiv.org/abs/2606.18230)
...
### [29] [PAHSPECS: Spatially Resolved PAH Spectroscopy at cosmic noon with JWST MIRI MRS](https://arxiv.org/abs/2606.18244)
...
### [30] [Nested Sampling: A Critical and Comprehensive Theoretical Guide](https://arxiv.org/abs/2606.17916)
...
### [31] [The free boundary problem in general relativity](https://arxiv.org/abs/2606.18128)
...
### [32] [OpenGadget3 GPU solver tests](https://arxiv.org/abs/2606.17145)
...
### [33] [A fast spectral-multigrid Poisson solver in non-Cartesian geometries](https://arxiv.org/abs/2606.17636)
...
### [34] [Hawai`i Supernova Flows: Bulk Flow Measurements using SNe Ia in the Optical and NIR](https://arxiv.org/abs/2606.17142)
...
### [35] [Tracing Ultra Light Axions in Post-reionization, Lyman-$α$ and CMB Missions](https://arxiv.org/abs/2606.17176)
...
### [36] [Damped Harmonic Oscillator Dark Energy and the Hubble Tension](https://arxiv.org/abs/2606.17550)
...
### [37] [Joint reconstruction of $H(z)$ and $fσ_8(z)$ with physics informed neural networks](https://arxiv.org/abs/2606.17614)
...
### [38] [Synergy between CSST and future gravitational-wave detectors: Probing primordial black holes by cross-correlating dark sirens with galaxies](https://arxiv.org/abs/2606.17617)
...
### [39] [PSZ: The meta-catalogue of Planck Sunyaev-Zeldovich sources](https://arxiv.org/abs/2606.17626)
...
### [40] [A rare sextuple-merging brightest cluster galaxy system in a disturbed galaxy cluster observed with the Einstein Probe Follow-up X-ray Telescope](https://arxiv.org/abs/2606.17700)
...
### [41] [Alleviating the Hubble tension with the $Λ_{ω_s}$CDM model](https://arxiv.org/abs/2606.17749)
*Youri Carloni*
...
### [42] [Two-population model of type Ia supernovae and their associations with host galaxies in ZTF DR2](https://arxiv.org/abs/2606.17802)
...
### [43] [Data-Driven Discovery of a Simple Phantom-Crossing Dark Energy Parametrization](https://arxiv.org/abs/2606.17951)
...
### [44] [Weak-lensing mass calibration of \emph{Planck} Sunyaev--Zel'dovich clusters with HSC-SSP Year~3](https://arxiv.org/abs/2606.17984)
...
### [45] [Constraints on the Sum of Neutrino Masses from ACT DR6 and DESI DR2 Considering Isocurvature Initial Conditions](https://arxiv.org/abs/2606.17994)
...
### [46] [Large primordial non-Gaussianity from transient turns in Higgs-$R^2$ inflation](https://arxiv.org/abs/2606.18095)
...
### [47] [Field-level vs summaries: convergence of information in non-Gaussian density fields](https://arxiv.org/abs/2606.18227)
...
### [48] [Pushing the Primordial Frontier: Exact Linear Solutions in Multifield Inflation](https://arxiv.org/abs/2606.18248)
