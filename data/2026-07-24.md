...
### [2] [New Type IIB Poly-instanton Effects and Axion Quintessence](https://arxiv.org/abs/2607.20613)
...
### [3] [Gravitational Wave Birefringence in generalized Palatini Chern Simons](https://arxiv.org/abs/2607.20689)
...
### [4] [Evolving Dark Energy from the Back-Reaction of Cosmological Perturbations](https://arxiv.org/abs/2607.20715)
*Vincent Comeau*
...
### [21] [A dust-free hierarchically nested supermassive-star model for James Webb Space Telescope Little Red Dots](https://arxiv.org/abs/2607.20617)
*Pau Amaro Seoane*
...
### [22] [Statistics on the population of distant substellar companions to nearby stars](https://arxiv.org/abs/2607.20673)
...
### [23] [HARPS Abundances with Korg I: 22 Element Abundances for 426 Red Giant Stars](https://arxiv.org/abs/2607.21001)
...
### [24] [Atmosphere mitigation in CMB observations using multi-frequency time-domain component separation](https://arxiv.org/abs/2607.21432)
...
### [25] [A multi-band radio flux density catalog of ICRF3 sources using the Onsala Twin Telescopes](https://arxiv.org/abs/2607.20671)
...
### [26] [Isotropic deceleration and near-zero baseline acceleration in Pantheon+ supernovae: new arguments in the dark energy debate](https://arxiv.org/abs/2607.20570)
...
### [27] [Gravitational Lensing Predictions from Wave Simulations of Fuzzy Dark Matter](https://arxiv.org/abs/2607.20614)
...
### [28] [What could an emerging Big Bang Nucleosynthesis discrepancy be hinting at?](https://arxiv.org/abs/2607.20635)
...
### [29] [The correlation between voids identified in 3D large-scale-structure and 2D weak-lensing maps](https://arxiv.org/abs/2607.20637)
...
### [30] [When galaxies burst II. Implications of enhanced burstiness for the 21-cm Cosmic Dawn signal](https://arxiv.org/abs/2607.20651)
...
### [31] [Probing the baryonic--dark matter connection in galaxy clusters using X-rays with gated recurrent unit neural networks](https://arxiv.org/abs/2607.20721)
...
### [32] [A Multimodal Approach to Star--Galaxy Separation using SPHEREx Spectrophotometry and DESI Legacy Survey Imaging](https://arxiv.org/abs/2607.20797)
...
### [33] [A lower bound on primordial power spectrum from halo substructure](https://arxiv.org/abs/2607.20884)
...
### [34] [Reviving the Affleck-Dine Curvaton Scenario with Compensated Isocurvature Perturbations](https://arxiv.org/abs/2607.21008)
...
### [35] [Inferences for f(R) Models from Late-Time Megamaser Observational Data](https://arxiv.org/abs/2607.21129)
...
### [36] [Hubble tension: the shape wall](https://arxiv.org/abs/2607.21244)
...
### [37] [Contribution to the 2026 Cosmology session of the 60th Rencontres de Moriond: Galactic moments: Understanding polarized foregrounds complexity in the quest for CMB primordial $B$ modes with LiteBIRD](https://arxiv.org/abs/2607.21247)
...
### [38] [Web-Halo Model Peak-Background Split (WHM-PBS): halo bias as a distribution, not a number](https://arxiv.org/abs/2607.21334)
...
### [39] [Hubble tension: a short review of theoretical explanations](https://arxiv.org/abs/2607.21497)
...
### [40] [Time-evolving Diagnostic of the Ionized Absorbers in NGC 4051. II. High-throughput Time-resolved Spectroscopy](https://arxiv.org/abs/2607.20621)
...
### [41] [Ultra-High-Energy Particle Production in Binary Mergers Endowed with Magnetic Fields](https://arxiv.org/abs/2607.21385)
