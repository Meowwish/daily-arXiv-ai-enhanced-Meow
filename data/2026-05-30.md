...
### [2] [Dynamical Tsallis WIMP Freeze-Out and Residual Memory Channels in the Radiation Sector](https://arxiv.org/abs/2605.29132)
*Matias P. Gonzalez*
...
### [3] [The energy conditions and model selection in the local Universe](https://arxiv.org/abs/2605.28903)
...
### [4] [Dominated-Convergence Failure in Cosmological Perturbation Theory and a Numerical Foundation for BBGKY+ZA](https://arxiv.org/abs/2605.28943)
*Svetlin V. Tassev*
...
### [5] [A Designer's Guide to Lunar Far-Side Interferometer Array: Power Spectrum Measurement and Cosmological Constraints from the Dark Ages](https://arxiv.org/abs/2605.29276)
...
### [6] [Model Independent Probe of Variation of Cosmic Opacity with Redshift](https://arxiv.org/abs/2605.29805)
...
### [7] [The observer power spectrum for lightcone statistics, integrated relativistic observables and wide angle effects](https://arxiv.org/abs/2605.29806)
...
### [8] [Exploring the High-Redshift 21-cm Signal via Self-Consistent Simulations using Artificial Neural Network Emulation](https://arxiv.org/abs/2605.29876)
...
### [9] [Cosmo-PINN: A Physics-Informed Neural Network for Cosmological Reconstruction](https://arxiv.org/abs/2605.30139)
...
### [10] [Signals from the early Universe: a comprehensive search for primordial features in Planck CMB datasets](https://arxiv.org/abs/2605.30236)
...
### [11] [Efficient computation of the galaxy angular bispectrum in redshift space](https://arxiv.org/abs/2605.30246)
...
### [13] [Augmented Correlation Functions for Spectroscopic Galaxy Surveys](https://arxiv.org/abs/2605.30305)
*Davide Bianchi*
...
### [14] [Physics Is All You Need? A Case Study in Physicist-Supervised AI Development of Scientific Software](https://arxiv.org/abs/2605.30353)
*Nhat-Minh Nguyen*
...
### [15] [Photometry is all you need: supernova classification as a mixing problem](https://arxiv.org/abs/2605.28922)
...
### [17] [Massive Stars in the Thirties: awaiting new Hubble discoveries](https://arxiv.org/abs/2605.28972)
...
### [18] [Extending Hubble into the 2030s to Resolve the Physics of LyC Escape](https://arxiv.org/abs/2605.30035)
...
### [19] [From Images to Orbits: A Hubble 2030s Astrometric Legacy for the M31-M33 Star Cluster Systems](https://arxiv.org/abs/2605.30249)
...
### [20] [Effective chemical potential and its phenomenological implications for the Hubble parameter](https://arxiv.org/abs/2605.28881)
...
### [22] [Problems of cosmology on small scales of the Universe](https://arxiv.org/abs/2605.29899)
*I. D. Karachentsev*
...
### [24] [Black Hole Photon Rings Saturate the Quantum Chaos Bound](https://arxiv.org/abs/2605.29923)
...
### [25] [The MeerKAT Thousand-Pulsar Polarization Array I: Properties of the Polarization and Rotation Measure Time Series Data](https://arxiv.org/abs/2605.29106)
...
### [26] [The Impact of the New $^{59}$Fe Decay Rates on $^{60}$Fe and $^{26}$Al Nucleosynthesis in Massive Stars](https://arxiv.org/abs/2605.29381)
...
### [29] [The incidence and star-formation properties of X-ray active galactic nuclei across the star-forming main sequence in DESI-eRASS1: the role of host-galaxy morphology](https://arxiv.org/abs/2605.28921)
...
### [30] [Too many protoclusters? Reconciling the overabundance of cluster progenitors within the first billion years of the Universe](https://arxiv.org/abs/2605.28930)
...
### [31] [A 1% distance to the Large Magellanic Cloud measured by population-II pulsating stars using Gaia Data Release 3](https://arxiv.org/abs/2605.28941)
...
### [32] [Closing the UV Gap: Rest-frame EUV science from high-redshift QSOs as a legacy-defining capability](https://arxiv.org/abs/2605.28948)
...
### [33] [Supermassive black holes in six triaxial galaxies: Insights from SINFONI and MUSE observations](https://arxiv.org/abs/2605.28959)
...
### [34] [A Deep Study of the Spiral Galaxy W2246f](https://arxiv.org/abs/2605.29014)
...
### [35] [Equilibrium Core and Vortex Solutions of Bose Einstein Condensate Dark Matter around a Black Hole](https://arxiv.org/abs/2605.29069)
...
### [36] [Compact near infrared sources in the center of the extraordinary galaxy IC 860](https://arxiv.org/abs/2605.29149)
...
### [37] [Modeling Solitonic Cores, Stabilization of Bar, and Suppression of Bar Dissolution in DDO 168 via GPP Formalism: A Detailed Analysis of Bose--Einstein Condensate/Fuzzy Dark Matter Halo Structure and Bar Dynamics in the Dwarf Galaxy DDO 168](https://arxiv.org/abs/2605.29314)
...
### [38] [An Obscured Tidal Disruption Event Uncovered by Its Mid- and Near-Infrared Dust Echo in a Star-Forming Galaxy](https://arxiv.org/abs/2605.29616)
...
### [39] [A New Cartwheel-like Collisional Ring Galaxy](https://arxiv.org/abs/2605.29618)
...
### [40] [MAMMOTH-Grism: Gas-phase Metallicity Gradients of Star-forming Galaxies in Protocluster Environments at Cosmic Noon](https://arxiv.org/abs/2605.29623)
...
### [41] [High-S/N Quasar Observations with HST/COS: Deep Fields for Spectroscopy](https://arxiv.org/abs/2605.29949)
...
### [42] [Multiple populations detection with the Chinese Space Station Survey Telescope main survey camera](https://arxiv.org/abs/2605.29504)
...
### [43] [Stellar Population Astrophysics (SPA) with the TNG. CNO abundances in 28 open clusters](https://arxiv.org/abs/2605.29666)
...
### [44] [Evidence of triggered star formation in the Pillars of Creation from JWST observations](https://arxiv.org/abs/2605.29904)
