...
### [1] [The JDISC Survey: Inner Disk Chemistry of Class I/FS Disks and Tentative Evidence for Early Pebble Drift](https://arxiv.org/abs/2607.22839)
...
### [2] [Nambu-Goldstone emissions from the cosmological evolution of global monopoles](https://arxiv.org/abs/2607.22481)
...
### [3] [Axion isocurvature and the model-building problem of low-scale inflation](https://arxiv.org/abs/2607.22809)
*Sarunas Verner*
...
### [4] [$\texttt{SNuDD}$: Solar Neutrinos for Direct Detection](https://arxiv.org/abs/2607.22817)
...
### [5] [High-frequency gravitational waves from axion inflation in the weak-backreaction regime](https://arxiv.org/abs/2607.23152)
...
### [6] [Status of light inflaton: from inflation to laboratory](https://arxiv.org/abs/2607.23200)
...
### [7] [Entropic Chaplygin-Gas cosmology and late-universe tension diagnostics](https://arxiv.org/abs/2607.22802)
...
### [8] [Parameter Estimation on LIGO-Virgo-KAGRA O4a Binary Merger Triggers with Sub-solar Mass Components](https://arxiv.org/abs/2607.23119)
...
### [9] [Probing Dark Matter Substructure with Wave-Optics Distortions of Strongly Lensed LISA Gravitational Waves](https://arxiv.org/abs/2607.22787)
...
### [10] [A charge-flow instability in plasmas with charge fluctuations](https://arxiv.org/abs/2607.22815)
...
### [11] [Relativistic Chiral MHD with application to the early Universe](https://arxiv.org/abs/2607.22816)
*Deepen Garg,Jennifer Schober*
...
### [12] [Stability in Axion Inflation with Strong Backreaction from a Massive Vector Boson](https://arxiv.org/abs/2607.22893)
...
### [13] [Measurement of All-sky Neutral hydrogen Absorption Spectrum (MANAS)](https://arxiv.org/abs/2607.23329)
...
### [14] [Interpreting the stacked kinetic SZ effect I: velocity reconstruction and non-linear velocity effects](https://arxiv.org/abs/2607.23339)
...
### [15] [The Degree of Fine-Tuning Needed for a Viable Universe: Not Fragile?](https://arxiv.org/abs/2607.23374)
*Fred C. Adams*
...
### [16] [Cosmological perturbations and clustering mechanisms in multifield dark energy](https://arxiv.org/abs/2607.23398)
...
### [17] [Hermes - Towards an Optimal High-Performance Algorithm for Cosmic Statistics of Large Data Sets](https://arxiv.org/abs/2607.23494)
...
### [18] [First Directional Dark Matter Limits from the MIMAC μ-TPC Detector](https://arxiv.org/abs/2607.23527)
...
### [19] [Cosmic microwave background temperature cosmography](https://arxiv.org/abs/2607.23535)
*C. J. A. P. Martins*
...
### [20] [Hierarchical Gaussian-process test of DESI's dynamical dark-energy preference](https://arxiv.org/abs/2607.23593)
...
### [21] [Scalar-induced gravitational waves from inflation with symmetry breaking](https://arxiv.org/abs/2607.23646)
...
### [22] [On the orbital eccentricities of primordial black hole binaries inside and outside of dark matter halos](https://arxiv.org/abs/2607.23892)
...
### [23] [The Pull of Stasis: A Study of the Dynamics of the Thermal Stasis Attractor](https://arxiv.org/abs/2607.23965)
...
### [24] [Testing Statistical Isotropy on the Sphere with Minkowski Tensors](https://arxiv.org/abs/2607.23973)
...
### [25] [ALAverse: A falsifiable anthropic model from the string landscape](https://arxiv.org/abs/2607.24100)
*Zhiqi Huang*
...
### [26] [Local luminosity functions of galaxies at (sub)millimeter wavelengths from Planck surveys](https://arxiv.org/abs/2607.24289)
...
### [27] [Constraining the $z \approx 1$ neutral hydrogen (HI) distribution](https://arxiv.org/abs/2607.24412)
...
### [28] [Updated 1.1% Precision Values of the Hubble Constant with Corrected Pantheon+ and Dark Energy Survey (DES)-DOVEKIE Type Ia Supernovae](https://arxiv.org/abs/2607.24443)
...
### [29] [The Nodal Line of the Galaxy Correlation Function as a Geometric Cosmological Probe](https://arxiv.org/abs/2607.24694)
*Lado Samushia*
...
### [30] [Gravitational waves from super-Hubble bubbles](https://arxiv.org/abs/2607.24734)
...
### [31] [Measuring Cosmic Neutrino Masses Independently of Dark Energy](https://arxiv.org/abs/2607.24742)
...
### [32] [Speeding up Gravitational Lens Mass Models with Machine Learning: Applications in X-ray Astronomy](https://arxiv.org/abs/2607.22812)
...
### [33] [Charting the Galactic Underworld I: Comprehensive simulations of the kinematics, rates, and demographics of Milky Way black holes](https://arxiv.org/abs/2607.22814)
...
### [34] [Reionization driven by the few: the ionizing budget of galaxies at z=5-10 from JWST/NIRSpec](https://arxiv.org/abs/2607.22834)
...
### [35] [Unsupervised selection and characterisation of Little Red Dots in JWST surveys with manifold learning](https://arxiv.org/abs/2607.22835)
...
### [36] [The role of filaments in the large-scale conformity signal](https://arxiv.org/abs/2607.22838)
...
### [37] [A quasar hatching from a buried red phase at z = 3.7](https://arxiv.org/abs/2607.22966)
...
### [38] [PhotoIFU: NIRCam as a Photometric Integral Field Unit for Mapping Feedback in Galaxies](https://arxiv.org/abs/2607.23020)
...
### [39] [HETDEX: Star Formation Stochasticity Diagram of Lyman Alpha Emitting Galaxies at Cosmic Noon Confirms Three Archetypes](https://arxiv.org/abs/2607.23062)
...
### [40] [Correlation between the two-armed $V_R$ spiral in the $Z$--$V_Z$ plane and moving groups](https://arxiv.org/abs/2607.23128)
...
### [41] [X-ray disc reverberation modelling of the X-ray/UV/optical spectral/timing properties of Fairall 9](https://arxiv.org/abs/2607.23267)
...
### [42] [The ALMA-QUARKS Survey: Properties of Hot Molecular Fragments in the Massive Protocluster IRAS 17233-3606](https://arxiv.org/abs/2607.23274)
...
### [43] [Disc Candidates in IC 2395: A WISE Survey of the Kinematically Confirmed Membership](https://arxiv.org/abs/2607.23612)
*Daniel Rose*
...
### [44] [On the Jeans criterion in hydrostatic stratified media](https://arxiv.org/abs/2607.23656)
...
### [45] [Spatial Correlations of PAH, UV, H$α$ Emission and IMF - PAH Variations in the Star-Forming Complexes of NGC 628](https://arxiv.org/abs/2607.23775)
...
### [46] [Neighbors, Not Kin: Kinematic evidence for tidal tails from NGC 7492 along the Sagittarius stream](https://arxiv.org/abs/2607.23829)
...
### [47] [The effect of triaxial galaxy shapes on the dynamics of triple supermassive black holes in a cosmological context](https://arxiv.org/abs/2607.23919)
...
### [48] [Evidence for Azimuthally Anisotropic MgII Absorption around DESI Luminous Red Galaxies](https://arxiv.org/abs/2607.24071)
*Xuanyi Wu,Cheng Li*
...
### [49] [Effects of temperature-dependent optical properties on the determination of interstellar dust masses](https://arxiv.org/abs/2607.24262)
...
### [50] [Radio Jet Properties of the Flaring Gamma-Ray Blazar PKS 0346-27](https://arxiv.org/abs/2607.24333)
...
### [51] [A Split-Flux Method for Dust-Gas Two-Fluid Simulations from Strong to Weak Coupling](https://arxiv.org/abs/2607.24418)
*Kazunari Iwasaki*
...
### [52] [Kinetic and H-atom product study of the C + C6H6 reaction at low temperatures](https://arxiv.org/abs/2607.24428)
...
### [53] [Cosmic ray heating of cold streams: Implications for the gas supply and growth of massive galaxies](https://arxiv.org/abs/2607.24461)
...
### [54] [Time-Domain Dust Astrophysics. I. Polarization Flares, Polarization-Angle Reverberation, and Fossil Imprints in Supernova-Illuminated Clouds](https://arxiv.org/abs/2607.24517)
*Thiem Hoang*
...
### [55] [Constraining young massive cluster properties with radio-continuum observations: The Arches cluster](https://arxiv.org/abs/2607.24580)
...
### [56] [Stellar Dynamics and Evolution of the Intermediate-Age Open Clusters NGC 2266 and NGC 2324](https://arxiv.org/abs/2607.24614)
...
### [57] [Laboratory spectroscopy, theoretical characterization, and astronomical search for syn-propenethial (CH2CHCHS)](https://arxiv.org/abs/2607.24656)
...
### [58] [Too many quiescent late-type galaxies or a matter of misclassification?](https://arxiv.org/abs/2607.24664)
...
### [59] [When galaxies cross cold fronts: wind tunnel simulations of ram pressure stripping](https://arxiv.org/abs/2607.24675)
...
### [60] [Expected number density of critical points of smooth Gaussian random fields in arbitrary dimensions](https://arxiv.org/abs/2607.23903)
...
### [61] [BOSS-CLAM: Utilizing a Constrained Linear Absorption Model to Infer Stellar Parameters from BOSS Spectra](https://arxiv.org/abs/2607.22822)
...
### [62] [A Century of Novae in the Large Magellanic Cloud](https://arxiv.org/abs/2607.23849)
*Allen W. Shafter*
...
### [63] [Constraining cosmological parameters from very-high-energy $γ$-ray attenuation in blazar spectra: Bayesian inference and systematic uncertainties](https://arxiv.org/abs/2607.23095)
...
### [64] [Probing an Intermediate-Mass Black Hole Companion of Sagittarius A* with Pulsar Timing](https://arxiv.org/abs/2607.24201)
...
### [65] [Constraints on the magnetic field in the hadronic scenario for the origin of the radio halo in the A1795 galaxy cluster](https://arxiv.org/abs/2607.24397)
