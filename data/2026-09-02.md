...
### [1] [Lynx2030 Science Analysis Group: Final Report](https://arxiv.org/abs/2609.00033)
...
### [2] [The promise of self-supervised and active learning for Strong Lens discovery: Astronomaly applied to KiDS](https://arxiv.org/abs/2609.00154)
...
### [3] [Radiative Corrections and Reheating in Supergravity Models of Inflation](https://arxiv.org/abs/2609.00221)
...
### [5] [Gravitational Waves from Reheating beyond Instantaneous Thermalization](https://arxiv.org/abs/2609.01480)
...
### [6] [Higgsino Dark Matter Interpretation of the LUX-ZEPLIN 248 keV Nuclear-Recoil Event](https://arxiv.org/abs/2609.01583)
...
### [7] [Viability of Big Bang Nucleosynthesis in $f(R,L_m)$ Gravity](https://arxiv.org/abs/2609.00017)
...
### [8] [Extended radio emission in and around the merging cluster A520 as seen by MeerKAT](https://arxiv.org/abs/2609.00156)
...
### [9] [TDCOSMO XXVIII. The Hubble constant from the quadruply lensed quasar J1537$-$3010 with precise time delays](https://arxiv.org/abs/2609.00179)
...
### [10] [Baryonic feedback suppression of the matter power spectrum: a three-parameter fitting formula and its single-parameter reduction](https://arxiv.org/abs/2609.00807)
*Pengjie Zhang*
...
### [11] [Combining Systematic Effects in CMB Polarization Experiments through map-based simulations: application to LiteBIRD's HWP non-idealities and detectors non-linearity](https://arxiv.org/abs/2609.00841)
...
### [12] [A Class of Exact Single-Field Inflationary Solutions beyond Slow Roll](https://arxiv.org/abs/2609.01003)
...
### [13] [Quantifying Sky Map Resolution Requirements for Beam Chromaticity Correction in Sky-Averaged 21 cm Experiments](https://arxiv.org/abs/2609.01125)
...
### [14] [The cosmic multipoles: a consistency test for the Szekeres cosmological model](https://arxiv.org/abs/2609.01154)
...
### [15] [Angular power spectrum of induced gravitational waves: breaking model and parameter degeneracies in PTA observations](https://arxiv.org/abs/2609.01193)
...
### [16] [First tomographic measurements of the angular clustering and bias of photometric quasars from S-PLUS](https://arxiv.org/abs/2609.01238)
...
### [17] [Energy deposited by black holes in the hot X-ray gas of elliptical galaxies, groups and clusters](https://arxiv.org/abs/2609.01407)
*A. Cattaneo,S. Ettori*
...
### [18] [Skyfire: A Spectroscopic Census of Little Red Dots and Broad-Line AGN in the CEERS Field](https://arxiv.org/abs/2609.00112)
...
### [19] [Weighing Little Red Dots with Transient Events](https://arxiv.org/abs/2609.00113)
...
### [20] [Reconciling Galactic rotation curve constraints with stellar stream modeling](https://arxiv.org/abs/2609.00114)
...
### [21] [Early Supermassive Black Holes and Little Red Dots Require Free-Fall Growth](https://arxiv.org/abs/2609.00115)
...
### [22] [ACES VII. Compact Continuum Source Catalog of the Central Molecular Zone](https://arxiv.org/abs/2609.00135)
...
### [23] [The Halo Gas of Local Spiral Galaxies and the Link to Gaseous Satellites](https://arxiv.org/abs/2609.00151)
...
### [24] [Local Heavily Obscured Active Galaxies Observed With Chandra (I): Spectral Properties of the Nuclear and Extended X-ray Emission](https://arxiv.org/abs/2609.00182)
...
### [25] [The gradual decline of Ly$α$ visibility in the CANDELS fields: evidence for the combined effects of galaxy evolution and reionization](https://arxiv.org/abs/2609.00199)
...
### [26] [Accretion-disk sizes in two quasars with interferometrically resolved broad-line regions at $z=2.3$ and $z=4.0$](https://arxiv.org/abs/2609.00278)
...
### [27] [ELVES-Dwarf. II. A Systematic Search for Satellite Systems of Dwarf Galaxies in the Local Volume](https://arxiv.org/abs/2609.00283)
...
### [28] [Deuteration of Organic Molecules as a Probe of Starless Core and Filament Evolution in Barnard 10](https://arxiv.org/abs/2609.00308)
...
### [29] [Formation of Heavy Seed Black Holes and Little Red Dots-like Compact Clusters in Metal-enriched Star-forming Regions](https://arxiv.org/abs/2609.00437)
...
### [30] [Detection of a triple nucleus in the Wolf-Rayet composite Sy 2 galaxy NGC 6764](https://arxiv.org/abs/2609.00496)
...
### [31] [Extragalactic Stellar Streams in Time-Dependent Cosmological Halos](https://arxiv.org/abs/2609.00526)
...
### [32] [The Stellar Populations of Two Quiescent Low Surface Brightness Dwarf Galaxies in Low Density Environments](https://arxiv.org/abs/2609.00693)
...
### [33] [H II region filling factors in NGC 628: Luminosity-size relation and connection with polycyclic aromatic hydrocarbon emission](https://arxiv.org/abs/2609.00902)
...
### [34] [Investigating the Young Stellar Populations and Hierarchies in Nearby Galaxies with the UVIT. III. Evidence for a Largest Scale of Correlated Stellar Structures and a Non-universal Fractal Dimension](https://arxiv.org/abs/2609.01065)
...
### [35] [The fraction of clumpy star-forming galaxies in nearby galaxies from CLAUDS and HSC-SSP](https://arxiv.org/abs/2609.01152)
...
### [36] [Sulphur within the extreme environment of the central molecular zone of NGC 253: a chemical modelling approach](https://arxiv.org/abs/2609.01162)
...
### [37] [The Physical Conditions of Low-Mass Galaxies at z=3.5-7.0 from JWST Spectroscopy: The Behaviour of Spectral Line Ratios with Burstiness](https://arxiv.org/abs/2609.01205)
...
### [38] [Slow stellar halo rotation as a signature of disc flips and GES-like mergers](https://arxiv.org/abs/2609.01208)
...
### [39] [Collisional excitation of cyclopentadiene by helium. A complete set of rate coefficients and astrophysical applications](https://arxiv.org/abs/2609.01314)
...
### [40] [Semiresolved Stellar Populations as Distance Indicators](https://arxiv.org/abs/2609.01400)
...
### [41] [The MWA Interestingly Deep AStrophysical (MIDAS) Survey: Survey Description and First Data Release](https://arxiv.org/abs/2609.01405)
...
### [42] [Irreducible-Mass Growth and Extractable Energy in a Self-Gravitating Blandford-Znajek Engine](https://arxiv.org/abs/2609.01534)
...
### [43] [The JWST Emission Line Survey (JELS): A narrow-band determination of the H$α$ Luminosity Function and Cosmic Star Formation into the Epoch of Reionization](https://arxiv.org/abs/2609.01586)
...
### [44] [Dissipative Multi-Field Dynamics from Non-Hermitian Inflationary Potentials](https://arxiv.org/abs/2609.00992)
*S. D. Campos*
...
### [46] [A Fast and Scalable Transformer Pipeline for Binary Black Hole Detection](https://arxiv.org/abs/2609.00339)
...
### [47] [Modeling Rotation in the Old, Cold Domain: Implications on Gyrochronology and the Stellar Magnetic Wind](https://arxiv.org/abs/2609.00134)
...
### [48] [SPIRITS 19q: Dust Production by a Subsolar-metallicity Carbon-rich Wolf-Rayet Star in NGC 2403](https://arxiv.org/abs/2609.00477)
...
### [49] [X-shooter survey Across Regions and Ages to probe Disk Evolution (ARADE): Accretion properties in Orion A and their relation with disk masses](https://arxiv.org/abs/2609.00938)
