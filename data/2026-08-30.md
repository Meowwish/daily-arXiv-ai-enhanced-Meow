...
### [1] [Carbon in J0815+4729: Casting A Shadow of Doubt on the Interpretation of CH Absorption in the Most Primitive Stars](https://arxiv.org/abs/2608.26731)
...
### [2] [NGTS clusters survey - VI: Stellar rotation in seven young open clusters within the PLATO LOPS2 field](https://arxiv.org/abs/2608.27170)
...
### [3] [Bright Metal-Poor Star Survey - I. Tomo-e Gozen narrow-band photometric survey and medium-resolution spectroscopic follow-up](https://arxiv.org/abs/2608.27220)
...
### [4] [Scatter, bias, and chaos of satellite orbits in triaxial dark matter haloes](https://arxiv.org/abs/2608.26249)
...
### [5] [Barren but not Empty: The Impact of Void Environments on Galaxy and Halo Populations](https://arxiv.org/abs/2608.26256)
...
### [6] [A Broken Clock Is Right Twice a Day: [Ce/Mg] Is Not a Universal Chemical Clock](https://arxiv.org/abs/2608.26261)
...
### [7] [The origin of the stellar mass-size relation of satellite galaxies in the COLIBRE simulations](https://arxiv.org/abs/2608.26275)
...
### [8] [Phase-Space Diagnostics for Dwarf Galaxies in Cluster Environments](https://arxiv.org/abs/2608.26293)
...
### [9] [COSMOS-Web: From early star-formation enhancement to late suppression in galaxy groups](https://arxiv.org/abs/2608.26348)
...
### [10] [Systematic uncertainties on DESI Tully-Fisher distances constrained with Integral Field Spectroscopy](https://arxiv.org/abs/2608.26459)
...
### [11] [A radio continuum view of Stephan's Quintet: age, dynamics and origin of the shock](https://arxiv.org/abs/2608.26461)
...
### [12] [Visualizing Disequilibrium: Tracing Two-Point Correlations to Specific Spatial Structures in the Milky Way](https://arxiv.org/abs/2608.26513)
...
### [13] [SERENADE III: Insight into the Origin of the High Dust Temperature and High [O III]/[C II] Ratio at $z\gtrsim6$](https://arxiv.org/abs/2608.26708)
...
### [14] [The solitary star cluster of the Andromeda XXV dwarf spheroidal](https://arxiv.org/abs/2608.26959)
...
### [15] [HURACAN: A comparison of stellar and interstellar proper motions inside L1688](https://arxiv.org/abs/2608.27067)
...
### [16] [Revisiting the enigmatic sixth star cluster in the Fornax dwarf spheroidal galaxy](https://arxiv.org/abs/2608.27270)
...
### [17] [Exploring the survivability of higher-order multiple protostellar systems -- The case of VLA1623](https://arxiv.org/abs/2608.27294)
...
### [18] [$N$-body simulations of the open cluster population in the Milky Way and the impact of GMC encounters](https://arxiv.org/abs/2608.27359)
...
### [19] [Non-isothermal vertical distribution functions for the Milky Way](https://arxiv.org/abs/2608.27373)
...
### [20] [LightCube: A Parsec-Resolution 3D Model of the Local Far-Ultraviolet Interstellar Radiation Field](https://arxiv.org/abs/2608.27389)
...
### [21] [Map of the Interstellar Continuum FUV Field within 800 Parsecs](https://arxiv.org/abs/2608.27400)
...
### [22] [Deuterium Production in an Effective Field Theory Constructed from On-Shell Amplitudes](https://arxiv.org/abs/2608.23699)
*Tim M. P. Tait*
...
### [23] [Engineering of titanium transition edge sensor wafers for the BA4-90/150 receiver of BICEP Array](https://arxiv.org/abs/2608.26202)
...
### [24] [The MegaWave Radio Surveyor](https://arxiv.org/abs/2608.26322)
...
### [25] [RadialPaths: Radial profiles in multi-centred astronomical structures](https://arxiv.org/abs/2608.26326)
*Rafael S. de Souza*
...
### [26] [Getting Warmer: IceCube Nears Freeze Out](https://arxiv.org/abs/2608.26258)
...
### [27] [Direct and Indirect searches for DM-electron interactions in sub-GeV DM models](https://arxiv.org/abs/2608.26467)
...
### [28] [$μ$DM: a new mechanism for the baryon-dark matter coincidence](https://arxiv.org/abs/2608.26709)
*Wen Yin*
...
### [29] [Optical Discovery of New and Candidate Galactic Supernova Remnants Plus Optical Imaging of the Monogem Ring Supernova Remnant](https://arxiv.org/abs/2608.26666)
...
### [30] [FRB 121102: No supernova-like ejecta or magnetar power, hinting at a binary WD merger](https://arxiv.org/abs/2608.26567)
...
### [32] [Primordial Black Holes as Cosmic Architects: Imprints of an extended mass function](https://arxiv.org/abs/2608.26247)
...
### [33] [Assembly bias from nuisance to probe II: Salvaging linear clustering from DESI and SDSS data](https://arxiv.org/abs/2608.26262)
...
### [34] [$\texttt{SPINE}$: Symbolic Models to Predict the Evolution of the $Λ$CDM Nonlinear Power Spectrum](https://arxiv.org/abs/2608.26276)
...
### [35] [The host galaxies of 2003fg-like type Ia supernovae](https://arxiv.org/abs/2608.26281)
...
### [36] [Paleo-Detectors as a Novel Probe of Dark Matter-Nucleus Effective Interactions](https://arxiv.org/abs/2608.26289)
...
### [37] [The Impact of Magnitude Uncertainties and K-corrections on Standard Siren Measurements of the Hubble Constant](https://arxiv.org/abs/2608.26307)
*M. Pálfi,P. Raffai*
...
### [39] [Cross-simulator transfer with foundation model summaries: Towards robust SKA-era reionization inference](https://arxiv.org/abs/2608.26354)
...
### [40] [Revisiting the Hubble tension with an inverse power-law early dark energy](https://arxiv.org/abs/2608.26507)
...
### [41] [Approximating the peculiar velocity distribution of dark matter halos with Tsallis statistics](https://arxiv.org/abs/2608.26572)
*Jun Pan,Ming Li*
...
### [42] [ELUCID-DESI II. Revealing dark matter mass, tidal, and velocity (MTV) fields using galaxy group phase information](https://arxiv.org/abs/2608.26668)
...
### [43] [Derivative hierarchy as the origin of kernel-dependent trends in Gaussian process reconstructions of the hubble parameter](https://arxiv.org/abs/2608.26774)
*Afaq Maqsood*
...
### [44] [Bumpy inflation from explosive particle production](https://arxiv.org/abs/2608.26920)
...
### [45] [Near universality of nonlinear transverse and radial velocity responses in spherical collapse with arbitrary radial profiles](https://arxiv.org/abs/2608.27376)
*Valerio Marra*
...
### [46] [The Atacama Cosmology Telescope: Constraints on the anisotropic screening and birefringence effects with DR6](https://arxiv.org/abs/2608.27458)
