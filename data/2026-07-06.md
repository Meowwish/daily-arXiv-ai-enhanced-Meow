...
### [2] [Can Primordial Black Holes Be Seeds for Early Galaxies in Models Satisfying the Covariant Entropy Bound?](https://arxiv.org/abs/2607.01292)
...
### [3] [No Evidence for Superradiant Axions in LIGO-Virgo-KAGRA GWTC-5 Binary Black Hole Spins](https://arxiv.org/abs/2607.01317)
...
### [4] [Axion Misalignment Across First-Order Phase Transitions](https://arxiv.org/abs/2607.01333)
...
### [6] [Gravitational Waves from Multiple First-Order Phase Transitions in a Scenario with Early Matter Domination](https://arxiv.org/abs/2607.01697)
...
### [7] [A critical look at low-scale cosmological phase transitions in the PTA era](https://arxiv.org/abs/2607.02505)
...
### [8] [TESS's First Bound Microlensing Planet: A Binary Microlensing Event Revealing a Planetary Companion toward the Galactic Plane](https://arxiv.org/abs/2607.01853)
...
### [24] [Pulsar Science with the SKAO](https://arxiv.org/abs/2607.01288)
...
### [25] [How I stop worrying about non-universality and $b_φ$: Constraining local $f_{\rm NL}$ with $b_φ$ priors from HOD posteriors](https://arxiv.org/abs/2607.01314)
...
### [26] [Lensing-Reconstructed Dark Matter-Intracluster Medium Coherence as a Probe of Cluster Dynamical State: Application to HSTFF, RELICS, and CLASH Clusters](https://arxiv.org/abs/2607.01389)
...
### [27] [Secondary Production of Photons from ALP Dark Matter interacting with a Cosmological Magnetic Field](https://arxiv.org/abs/2607.01399)
...
### [28] [Lattice study of primordial black hole formation in bumpy axion inflation](https://arxiv.org/abs/2607.01780)
...
### [29] [Gravitational Waves from Primordial Black Holes: Connecting Low-Frequency Scalar-Induced Signatures to High-Frequency Binary Mergers](https://arxiv.org/abs/2607.01818)
*Ashu Kushwaha*
...
### [30] [meer21cm: an Analysis Pipeline and Comprehensive Toolkit for HI Intensity Mapping](https://arxiv.org/abs/2607.01864)
...
### [31] [Spherically Symmetric Fluid Simulations of Black Hole Accretion in Self-Interacting Dark Matter Halos](https://arxiv.org/abs/2607.02151)
...
### [32] [Alleviating prior dependencies for DESI DR1 clustering fits through reparameterization](https://arxiv.org/abs/2607.02498)
