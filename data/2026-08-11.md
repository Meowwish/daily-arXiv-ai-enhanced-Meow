...
### [1] [Correlated parity violation in gravity and electromagnetism from five-dimensional spacetime](https://arxiv.org/abs/2608.09299)
...
### [2] [Observational constraints on fractional holographic dark energy in the light of DESI DR2](https://arxiv.org/abs/2608.09379)
...
### [3] [Adiabatic Perturbations in GW170817-Compatible Einstein-Gauss-Bonnet Inflation](https://arxiv.org/abs/2608.09783)
...
### [4] [NATA: a chemical-picture equation of state for stellar merger hydrodynamics](https://arxiv.org/abs/2608.07829)
*Natalia Ivanova*
...
### [5] [JWST Reveals a Galaxy-Wide Association of Red Supergiants with OB Stars in NGC 5584](https://arxiv.org/abs/2608.08006)
...
### [6] [Sector-based morphological analysis of four planetary nebulae (J 320, NGC 2610, A 6672 and PRTM 1) observed with UVIT/ASTROSAT](https://arxiv.org/abs/2608.09582)
...
### [7] [IPA: Morphology and Kinematics of Molecular Hydrogen Winds in Five Young Protostars across the Mass Spectrum Observed with JWST](https://arxiv.org/abs/2608.09920)
...
### [8] [Locating the missing baryons in the warm-hot intergalactic medium with fast radio bursts and the Sunyaev-Zel'dovich effect](https://arxiv.org/abs/2608.09014)
...
### [9] [Impact of disk magnetic fields on the propagation of stellar-scale jets in the magnetically arrested accretion disks of active galactic nuclei](https://arxiv.org/abs/2608.09284)
...
### [10] [Global simulations of accretion flows onto perturbers embedded in magnetized disks -I. MRI and jet formation in ideal MHD](https://arxiv.org/abs/2608.09471)
...
### [11] [Recoiling Black Holes I. Burst of Observables](https://arxiv.org/abs/2608.09662)
...
### [12] [GLOW I: Comprehensive Measurements of Gas-Rich, Star-Forming, Low-Mass Galaxies in the Nearby Universe](https://arxiv.org/abs/2608.07659)
...
### [13] [GLOW II: A Census of Oxygen in Low-Mass Galaxies](https://arxiv.org/abs/2608.07665)
...
### [14] [First Light and Assembly of GalaxieS (FLAGS) I: The JWST/NIRCam Number Counts and IGL as Constraints on Galaxy Formation Models](https://arxiv.org/abs/2608.07668)
...
### [15] [Scattering from Dusty Outflows in Hot Dust-Obscured Galaxies with Blue Excess Emission](https://arxiv.org/abs/2608.07669)
...
### [16] [Radial Stellar Age Gradients in 42 Local Volume Dwarf Galaxies](https://arxiv.org/abs/2608.07671)
...
### [17] [The large-scale ordered magnetic field in the Galactic halo and the Local Bubble](https://arxiv.org/abs/2608.07679)
*Elena Orlando*
...
### [18] [Mapping gas accretion and stellar kinematics to sub-kiloparsec scales in NGC 4696 with JWST/NIRSpec](https://arxiv.org/abs/2608.07732)
...
### [19] [The Circumgalactic Medium of Present-Epoch Luminous Galaxies as Probed by CIV Absorption](https://arxiv.org/abs/2608.07752)
...
### [20] [A Two-level Radial-velocity Zero-point Calibration for LAMOST MRS with Gaia and APOGEE and a Value-added RV Catalogue](https://arxiv.org/abs/2608.07962)
...
### [21] [First detection of C2H+ in the interstellar medium](https://arxiv.org/abs/2608.08014)
...
### [22] [Breathing Fire: Hot Dust in the Big Three Dragons at z = 7.15](https://arxiv.org/abs/2608.08015)
...
### [23] [Diagnosing the Fe line complex of the intracluster medium by XRISM high-resolution spectroscopy](https://arxiv.org/abs/2608.08094)
...
### [24] [A New Window on the Hα Luminosity Function and Star Formation Rate Density from 1.2 < z < 6.6 from JWST Medium-Band Photometry](https://arxiv.org/abs/2608.08203)
...
### [25] [Kings of the Milky Way: A Homogeneous Gaia DR3 Analysis of King Open Clusters and the Galactic Disc Metallicity Gradient](https://arxiv.org/abs/2608.08216)
...
### [26] [The Quasar Feedback Survey: Ionised Outflows in type 2 QSOs with MUSE data](https://arxiv.org/abs/2608.08275)
...
### [27] [KCWI Discovery of a Spatially Resolved Kpc-Scale Ionized Outflow in NGC 1275](https://arxiv.org/abs/2608.08331)
...
### [28] [GATOS: Distinct Feedback Modes in AGN Central Regions Revealed by Spatially Resolved JWST Spectroscopy](https://arxiv.org/abs/2608.08369)
...
### [29] [The ALMA carbon monoxide supernova (ACOS) survey II. Turbulent giant molecular clouds at the positions of core-collapse supernovae](https://arxiv.org/abs/2608.08380)
...
### [30] [Constructing a Hydrogen Line Library for Lyα Emitters at Low Redshifts (z < 0.4): Estimating Dust Extinction and Assessing Paschen line Detectability with SPHEREx](https://arxiv.org/abs/2608.08393)
...
### [31] [A Catalog of Giant Radio Source Candidates from TGSS ADR1 Using a Deep Learning--based Pipeline](https://arxiv.org/abs/2608.08410)
...
### [32] [Exploration of UV-bright sources in Globular cluster NGC 3201 using UVIT observations](https://arxiv.org/abs/2608.08560)
...
### [33] [An Identifiability Audit of One-Parameter Structural Corrections to the Radial Acceleration Relation in SPARC](https://arxiv.org/abs/2608.08945)
*Lukas A. Sosna*
...
### [34] [Unveiling Metal Mixing in a Grand-Design Spiral: A UV-optical multiphase spatially resolved study of M83](https://arxiv.org/abs/2608.09064)
...
### [35] [Statistical inference of fast radio burst environments using galaxy number density](https://arxiv.org/abs/2608.09192)
...
### [36] [AGN activity in nearby disk galaxies: the roles of bar strength and spiral-arm morphology](https://arxiv.org/abs/2608.09320)
...
### [37] [A Partial Lyman Limit Absorber in the Halo of a Galaxy Pair: A Possible Signature of Gas Inflow](https://arxiv.org/abs/2608.09418)
...
### [38] [The Environmental Dependence of Star Cluster Demographics](https://arxiv.org/abs/2608.09439)
...
### [39] [Dust production in the harsh environment of Sgr A* - MIRI/JWST observation of the O-rich asymptotic giant branch star IRS~3](https://arxiv.org/abs/2608.09511)
...
### [40] [Searching for low-surface-brightness galaxies with compact neural networks A parameter-efficient approach to first-pass selection of diffuse galaxy in HSC-SSP imaging](https://arxiv.org/abs/2608.09566)
...
### [41] [Ubiquitous Interstellar Neutral Helium Detected with JWST](https://arxiv.org/abs/2608.09587)
...
### [42] [A Chemical Inventory of the Disk around the Class 0 Protostar L1527 IRS with ALMA](https://arxiv.org/abs/2608.09627)
...
### [43] [An emerging baryon cycle in a galaxy 500 million years after the Big Bang](https://arxiv.org/abs/2608.09813)
...
### [45] [QUIJOTE scientific results - XX. Commissioning and First Results from the Thirty and Forty Gigahertz Instrument (TFGI)](https://arxiv.org/abs/2608.08579)
...
### [46] [Foreground Subtraction with a Tensor-Based Oriented Singular Value Decomposition Method for HI Experiments](https://arxiv.org/abs/2608.09129)
...
### [47] [Kratos-linerad: GPU-accelerated Monte Carlo radiative transfer of lines with efficient imaging](https://arxiv.org/abs/2608.09340)
*Lile Wang*
...
### [48] [Deus ex $H_0$ -- Is evidence for dynamical dark energy conditioned on early cosmology?](https://arxiv.org/abs/2608.07654)
...
### [49] [Probability of gravitational-wave lensing by intermediate-mass black holes and globular clusters](https://arxiv.org/abs/2608.07667)
...
### [50] [Axion dark matter search with a photonic bandgap cavity haloscope and dielectric tuning rod over 10.25-10.45 GHz](https://arxiv.org/abs/2608.07718)
...
### [51] [The Impact of Splashback Galaxies on Galaxy Assembly Bias](https://arxiv.org/abs/2608.07791)
...
### [52] [Inflationary Axion Isocurvature in the CMB across All Ultralight Masses](https://arxiv.org/abs/2608.07803)
...
### [53] [Implicit Likelihood Inference and $z$-Binned Reconstruction of Dark Energy $w(z)$](https://arxiv.org/abs/2608.08007)
...
### [54] [Multi-tracer mass bias in matched cosmic voids from SDSS DR7 and the ELUCID constrained simulation](https://arxiv.org/abs/2608.09086)
...
### [55] [Big-Bang Nucleosynthesis and WIMP Dark Matter Freeze-Out as Probes of Yukawa Cosmology](https://arxiv.org/abs/2608.09390)
...
### [56] [CMB Spectral Distortion Anisotropies from Acoustic Damping with primordial non-Gaussianity](https://arxiv.org/abs/2608.09457)
...
### [57] [Cross-frequency SGWB anisotropy from compact topology: CMB B-mode covariance as a transfer probe](https://arxiv.org/abs/2608.09697)
*Li-E Qiang,Peng Xu*
...
### [58] [Not R Kurvature: Beating Large-Scale White Noise](https://arxiv.org/abs/2608.09709)
*Wayne Hu*
...
### [59] [The Fate of Large Scale White Noise in Second-Order Cosmological Perturbation Theory](https://arxiv.org/abs/2608.09897)
*Aurora Ireland*
...
### [60] [Realization Variance of Gravitational Wave Background Anisotropies from Shot Noise for Pulsar Timing Arrays](https://arxiv.org/abs/2608.09929)
...
### [61] [Thermal Origin of Black Hole Quasinormal Modes](https://arxiv.org/abs/2608.09797)
