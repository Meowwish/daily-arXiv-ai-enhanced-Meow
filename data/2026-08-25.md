...
### [1] [Circularly polarized gravitational waves from parity-violating scalar-tensor theory](https://arxiv.org/abs/2602.07430)
...
### [2] [Effective Field Theory for Freezing Gravity with Minimally Coupled Matter](https://arxiv.org/abs/2608.20085)
*Zhibang Yao*
...
### [4] [TeV-scale leptogenesis in a parity symmetric neutrino mass model](https://arxiv.org/abs/2608.19367)
...
### [5] [Tunneling from a Slowly Rolling Multifield Background Using Tadpole Subtraction](https://arxiv.org/abs/2608.20451)
*Masaki Yamada*
...
### [6] [Qubits for Dark Matter Hunting](https://arxiv.org/abs/2608.20745)
*Takeo Moroi*
...
### [7] [Mapping the z>=5 SiIV Column Density Distribution onto the Galaxy Stellar Mass Function Using the Cumulative Absorption Cross Section](https://arxiv.org/abs/2608.20609)
...
### [8] [Pandora cluster Lensing, AGN, and Transient Exploration (PLATE) from JWST Multi-Epoch Imaging. I. Discovery of a type II supernova candidate in a spiral galaxy at $z=0.7$](https://arxiv.org/abs/2608.20781)
...
### [9] [Ultra-Deep imaging of the starless galaxy candidate Cloud-9](https://arxiv.org/abs/2608.20911)
...
### [10] [Gas-phase and Surface Chemistry in the Massive Star-Forming Region RCW\,120](https://arxiv.org/abs/2608.21002)
...
### [11] [The superclumps of the local Milky Way. Supercloud fragmentation and the sites of star formation](https://arxiv.org/abs/2608.21028)
...
### [12] [The GASKAP-HI Survey towards the Magellanic Clouds: Cold Atomic Gas Survival and Evolution in the Large Magellanic Cloud](https://arxiv.org/abs/2608.21115)
...
### [13] [The curious case of HCO$^+$: Extreme abundances under extreme conditions](https://arxiv.org/abs/2608.21138)
...
### [14] [Angular momentum in isolated disc galaxies: Insights from TNG100](https://arxiv.org/abs/2608.21139)
...
### [15] [The [Ne V] AGN Diagnostic in SDSS-IV/eBOSS: An Anticorrelation Between Ionization State and AGN Luminosity in Low-Redshift Coronal-Line Galaxies](https://arxiv.org/abs/2608.21280)
...
### [16] [The Random Magnetic Field of the Milky Way](https://arxiv.org/abs/2608.21293)
...
### [17] [A comparative study of emergent dark energy models](https://arxiv.org/abs/2608.20415)
...
### [18] [On what scales does strong lensing robustly constrain the mass profile of low-mass perturbers?](https://arxiv.org/abs/2608.20454)
...
### [19] [One-point matter PDFs beyond TopHat filters](https://arxiv.org/abs/2608.20457)
...
### [20] [Probing cosmological phase transitions with SKAO through nano-Hz gravitational-wave portal](https://arxiv.org/abs/2608.20897)
...
### [21] [Physical Calibration of a Minimal Effective Field Theory of the Three-Dimensional Lyman-$α$ Forest](https://arxiv.org/abs/2608.21226)
...
### [22] [Model independent lensing sub-structure detection with multiply-imaged star clusters constellations](https://arxiv.org/abs/2608.21253)
...
### [23] [Diversity of Galaxy Centers from Small-Scale Isocurvature](https://arxiv.org/abs/2608.21323)
...
### [24] [High-Energy Neutrino Constraints on memory burdened Bardeen and Kerr Primordial Black Holes](https://arxiv.org/abs/2608.21353)
...
### [25] [From Timbuktu to SKA: Who owns the Astronomy knowledge Africa produces?](https://arxiv.org/abs/2608.21119)
...
### [26] [Amplifying the imaging power of digital sky surveys with space telescopes data and generative AI](https://arxiv.org/abs/2608.20666)
