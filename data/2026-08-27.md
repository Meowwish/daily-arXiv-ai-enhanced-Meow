...
### [1] [Aliased noise characterization and mitigation in BICEP Array 150, 220 and 270 GHz time-division multiplexed detectors](https://arxiv.org/abs/2608.25011)
...
### [2] [Black hole astrometric binaries in the Roman Galactic Bulge Time Domain Survey](https://arxiv.org/abs/2608.24998)
...
### [3] [EncoTESS: Age-Sensitive Encodings from Raw TESS Light Curves](https://arxiv.org/abs/2608.25019)
...
### [4] [ABYSS. IV. Identifying signatures of stellar youth in APOGEE spectra](https://arxiv.org/abs/2608.25170)
...
### [5] [The properties of the first continuous gravitational waves: Optimizing pulsar timing observations for supermassive black hole binary detection](https://arxiv.org/abs/2608.25715)
...
### [7] [Dynamics and Spectra-Polarimetric Signatures of GRMHD Simulations with Multiple Magnetic Loops](https://arxiv.org/abs/2608.25763)
...
### [8] [Particle acceleration in Alfvénic turbulence with a strong guide field](https://arxiv.org/abs/2608.25985)
...
### [9] [Multi-messenger signal from QCD-Axion Ultracompact Minihalos](https://arxiv.org/abs/2608.25338)
...
### [10] [What would it take for dark matter to be literally warm?](https://arxiv.org/abs/2608.24990)
*Katelin Schutz*
...
### [11] [Enhancing dark siren cosmology via Gaussian process reconstruction of incomplete galaxy catalogs](https://arxiv.org/abs/2608.24992)
...
### [12] [Slowly Rolling on a Quantum Correction](https://arxiv.org/abs/2608.25004)
...
### [13] [Quantifying the systematic impact of differential beam response on the BICEP CMB polarization data from 2016 through 2024](https://arxiv.org/abs/2608.25016)
...
### [14] [Cosmic topology. Part Va. Information content of the observable Universe](https://arxiv.org/abs/2608.25033)
...
### [15] [The optimal redshift for dark energy I: formalism and interpretation](https://arxiv.org/abs/2608.25229)
...
### [16] [The optimal redshift for dark energy II: application to cosmological data and the evidence for the phantom crossing of the CPL equation of state](https://arxiv.org/abs/2608.25278)
...
### [17] [Distinguishing cold and self-interacting dark matter through topological analysis](https://arxiv.org/abs/2608.25632)
...
### [18] [Constraining primordial non-Gaussianity and energy injection with the thermal Sunyaev-Zeldovich effect and integrated Sachs-Wolfe effect cross-correlation](https://arxiv.org/abs/2608.25809)
...
### [19] [Filaments within filaments: unraveling the hierarchy of the cosmic web](https://arxiv.org/abs/2608.25840)
...
### [20] [An Inverse Lyth Bound for Non-Attractor Inflation](https://arxiv.org/abs/2608.25911)
*William H. Kinney*
...
### [21] [SMUDGes Below the Surface: Clusters Confirm the Diversity of Low-Surface-Brightness Galaxies](https://arxiv.org/abs/2608.24991)
...
### [22] [The ionizing properties of JWST's compact broad-line emitters](https://arxiv.org/abs/2608.25021)
...
### [23] [To be lensed or not to be lensed: on the nature of the alleged high-z lensed quasars J0109-5424 and P170+20](https://arxiv.org/abs/2608.25044)
...
### [24] [Tracing Galaxy Bias Through the Cosmic Web: The Role of Filaments](https://arxiv.org/abs/2608.25060)
...
### [25] [A systematic study of AGN feedback in a disk galaxy using MACER. III. High Gas Fractions in AGN Hosts](https://arxiv.org/abs/2608.25341)
...
### [26] [Laplace surface of eccentric orbits around Kerr black hole and black-hole effects on Lidov-Kozai cycles](https://arxiv.org/abs/2608.25353)
...
### [27] [Recovering the effective impact parameters in integral-field absorption-line tomography](https://arxiv.org/abs/2608.25364)
...
### [28] [Infrared photoprocessing of porous amorphous solid water with a free electron laser](https://arxiv.org/abs/2608.25473)
...
### [29] [Energetics of AGN Feedback](https://arxiv.org/abs/2608.25571)
...
### [30] [The Nobeyama 45 m Survey of Shocked Molecular Gas in the Central Molecular Zone. I. Survey Data, Cloud Catalog, and SiO Line-Ratio Trends](https://arxiv.org/abs/2608.25611)
...
### [31] [Revealing Galactic dust beneath the cosmic infrared background anisotropies with Wavelet Phase Harmonics](https://arxiv.org/abs/2608.25617)
...
### [32] [Stellar mass growth in COSMOS-Web: a mass-complete main sequence to z ~ 8 and its consistency with GSMF evolution](https://arxiv.org/abs/2608.25671)
...
### [33] [Evidence for the transformation from lenticular to spiral galaxies](https://arxiv.org/abs/2608.25673)
...
### [34] [Formation of Accretion Disks around Intermediate-Mass Black Holes in Ultra Compact Dwarf Galaxies and Nuclear Stellar Clusters](https://arxiv.org/abs/2608.25856)
...
### [35] [HII-CHI-mistry for active galactic nuclei: optical sulphur abundances without empirical ionisation correction factors](https://arxiv.org/abs/2608.25919)
...
### [36] [REBELS-25: multi-phase morphology and kinematics at z = 7.31](https://arxiv.org/abs/2608.25982)
...
### [37] [Accretion Disk Sizes and Temperature Profiles in Lensed Quasars: NIR Microlensing Challenges Thin Disk Theory](https://arxiv.org/abs/2608.26039)
...
### [38] [Probing the Properties of Neutral Clouds in the Vicinity of the Local Bubble: Linking three-dimensional Dust with Neutral Hydrogen Absorption](https://arxiv.org/abs/2608.26098)
...
### [39] [Defining higher memory signals and forecasting their observation prospects for binary-black-hole mergers with next-generation gravitational-wave detectors](https://arxiv.org/abs/2608.23739)
