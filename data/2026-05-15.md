...
### [4] [Exploring the CMB in Anisotropic Universes](https://arxiv.org/abs/2605.14970)
...
### [5] [Unified dark sector and Hubble-tension alleviation in scalar-vector-tensor gravity](https://arxiv.org/abs/2605.14977)
...
### [6] [Can a late-time cosmological model based on baby universe absorption explain the z-variation of w?](https://arxiv.org/abs/2605.15045)
...
### [7] [The Magnetic Origin of Primordial Black Holes: Ultralight PBHs and Secondary GWs](https://arxiv.org/abs/2605.14044)
...
### [8] [Single field matter bounce with dark energy era: comparison with CMB Planck 2018 data and best fit parameters](https://arxiv.org/abs/2605.14088)
...
### [9] [KiDS+VIKING-450 cosmology with Bayesian hierarchical model redshift distributions](https://arxiv.org/abs/2605.15078)
...
### [10] [Strong Gravitational Lensing with the James Webb Space Telescope](https://arxiv.org/abs/2605.15189)
*Adi Zitrin*
...
### [11] [Isocurvature-Free QCD Axion Dark Matter from Inflaton-Driven Early QCD: the Necessity of Inflationary Plateaus](https://arxiv.org/abs/2605.15192)
...
### [12] [Primordial Black Hole from Tensor-induced Density Fluctuation: First-order Phase Transitions and Domain Walls](https://arxiv.org/abs/2605.15197)
...
### [13] [The Hunt for Red Dual AGNs I: Spatially-Resolved Mid-IR Dual AGNs in the DeCam Legacy Survey](https://arxiv.org/abs/2605.13946)
...
### [14] [Massive Galaxies Form Early and Gray: Stellar Assembly and Dust Attenuation at $\mathbf{z>3.5}$ from CAPERS](https://arxiv.org/abs/2605.13966)
...
### [15] [When galaxies burst: enhanced shot-noise for line-intensity mapping in the JWST era](https://arxiv.org/abs/2605.13967)
...
### [16] [Determining star formation histories and age-metallicity relations with convolutional neural networks](https://arxiv.org/abs/2605.13973)
...
### [17] [Ionization Structure and Metal Enrichment of the Galactic Center Minispiral Observed with JWST](https://arxiv.org/abs/2605.13995)
...
### [18] [Constraining the Galactic Center Dark Cluster with ELT/MICADO Observations](https://arxiv.org/abs/2605.14017)
...
### [20] [Boundary-supported radial layering in Hoag-like ring galaxies](https://arxiv.org/abs/2605.14725)
...
### [21] [DREAMS. JWST Spectroscopy of a $z=8.3$ Galaxy with an ALMA Dust Continuum Detection: Early Dust, Very High $T_{\rm dust}$, and a Multi-wavelength [OIII] Ratio Discrepancy](https://arxiv.org/abs/2605.14922)
...
### [25] [Not All Who Wander Are Lost: Early Excess Demographics in the Volume-limited ZTF DR2 SN Ia Sample](https://arxiv.org/abs/2605.14437)
...
### [26] [Infrared Line Diagnostics Fail to Constrain Sgr A*'s UV Output](https://arxiv.org/abs/2605.13990)
...
### [27] [Beyond AI as Assistants: Toward Autonomous Discovery in Cosmology](https://arxiv.org/abs/2605.14791)
...
### [28] [Exploring neutrino loss with diffuse astrophysical neutrino fluxes](https://arxiv.org/abs/2605.13955)
...
### [29] [Effective Matter Flavor Conversion Mediated by Pseudo-Sterile States as the Possible Origin of Neutrino Oscillation Anomalies](https://arxiv.org/abs/2605.15146)
