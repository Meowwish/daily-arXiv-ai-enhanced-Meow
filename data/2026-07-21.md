...
### [1] [All Tree-Level Massive Cosmological Correlators via Spectral Gluing](https://arxiv.org/abs/2607.18223)
...
### [2] [gevolution 2.0: GPU-accelerated relativistic N-body simulations for cosmology](https://arxiv.org/abs/2607.17929)
...
### [4] [Optically Thick Outflow Driven by Supercritical Accretion May Explain Little Red Dots](https://arxiv.org/abs/2607.17448)
...
### [5] [Black hole spin-mass correlation and vector resonant relaxation in gaseous star clusters: the origin of GW231123?](https://arxiv.org/abs/2607.17869)
*Zacharias Roupas*
...
### [6] [Quantifying the Information Gain from Future High-Precision Radius Measurements for Identifying Twin Neutron Stars](https://arxiv.org/abs/2607.18124)
...
### [7] [Earth as a transducer for ultralight bosonic dark-matter detection](https://arxiv.org/abs/2607.16342)
...
### [9] [Wide binaries in ultra-faint dwarf galaxies as a probe of extended dark objects](https://arxiv.org/abs/2607.18185)
...
### [10] [Theoretical uncertainties in reconstructing model parameters with gravitational waves from supercooled phase transitions](https://arxiv.org/abs/2607.18233)
...
### [11] [Dynamical friction in stratified stellar envelopes](https://arxiv.org/abs/2607.16422)
*Damien Gagnier*
...
### [12] [Determination of [Fe/H] in Fundamental mode Classical Cepheids from Gaia DR3 light curve Fourier parameters](https://arxiv.org/abs/2607.16775)
...
### [13] [Escaped White Dwarf Candidates from Open Clusters](https://arxiv.org/abs/2607.16815)
...
### [14] [Magnetic fields in Massive Star-Forming Regions (MagMaR). VIII. Magnetic field overrun by gravity in GGD 27's accretion streamers](https://arxiv.org/abs/2607.17160)
...
### [16] [Probabilistic Stellar Age Estimation for Gaia XP Stars with NGBoost](https://arxiv.org/abs/2607.17932)
...
### [17] [Rolling Galileons: Evolving Braiding Strength for Viable Dark Energy](https://arxiv.org/abs/2607.16395)
...
### [18] [The Goldstone Awakens: Unimodular dark energy in scale-invariant $R^2$ gravity](https://arxiv.org/abs/2607.16405)
...
### [20] [Unveiling dark energy properties with high-sensitivity cross-correlations of neutral hydrogen intensity mapping and galaxy surveys](https://arxiv.org/abs/2607.17141)
...
### [21] [Microlensing of Microlensing: Effects of Random Stars on the Double-Source-Plane Gravitational Lens](https://arxiv.org/abs/2607.17144)
...
### [22] [One Year and One Night to 1% in $\mathbf{H_0}$: Efficient Spectroscopic Strategy for Dark Siren Cosmology](https://arxiv.org/abs/2607.17284)
...
### [23] [Constraints on Primordial Black Hole Dressed by Dark Matter Halo from Microlensing Effect of Fast Radio Bursts](https://arxiv.org/abs/2607.17338)
...
### [24] [Simultaneous inference of isotropic and anisotropic polarization rotation angles for next-generation cosmic microwave background experiments](https://arxiv.org/abs/2607.17500)
...
### [25] [Repulsive dark matter from Hosotani mechanism](https://arxiv.org/abs/2607.17727)
...
### [26] [Intracluster light and dark matter halo shapes reflect common assembly, not mutual coupling: shape correspondence in CDM but not SIDM](https://arxiv.org/abs/2607.17792)
...
### [27] [Magnetically assisted primordial scalar perturbations: Scalar-Induced Gravitational Waves](https://arxiv.org/abs/2607.17875)
...
### [28] [Comparing explicit likelihood and likelihood-free simulation-based inference for weak lensing cosmic shear](https://arxiv.org/abs/2607.17942)
...
### [29] [Core-Halo Mass Relation in Cosmological Vector Dark Matter](https://arxiv.org/abs/2607.18025)
...
### [30] [Biased Domain Wall Networks and their Gravitational Waves](https://arxiv.org/abs/2607.18107)
...
### [31] [Benchmarking wall velocities in cosmological phase transitions: Fluid Ansatz and WallGo](https://arxiv.org/abs/2607.18207)
...
### [32] [Breaking the $f_{\text{NL}}$--$b_φ$ degeneracy with the time evolution of tracer number counts](https://arxiv.org/abs/2607.18229)
...
### [33] [Cosmological consequences of a dynamical dark matter in the light of DESI DR2 measurements](https://arxiv.org/abs/2607.18234)
...
### [34] [From Triadic Interactions to Kolmogorov Scaling: A Deterministic, Scale-Resolved Formulation of Energy Flux](https://arxiv.org/abs/2607.16381)
*Erik Bertram*
...
### [35] [Reconstructions of Horndeski Subclasses by Gaussian Processes](https://arxiv.org/abs/2607.14154)
...
### [37] [Cosmological simulations of the high-redshift galaxy population adopting a variable stellar initial mass function](https://arxiv.org/abs/2607.16404)
...
### [38] [LoVoCCS. III. Third Generation Pipeline & The Hercules Supercluster](https://arxiv.org/abs/2607.16417)
...
### [39] [VAR-PZnn: A machine-learning framework for AGN photometric redshifts using color and variability-based features](https://arxiv.org/abs/2607.16434)
...
### [40] [The size of the HI disk across different environments: isolated, compact groups, clusters, and pairs](https://arxiv.org/abs/2607.16467)
...
### [41] [Fragmentation of massive clumps: constant mass fraction and growing mass inequality of cores](https://arxiv.org/abs/2607.16522)
...
### [42] [Tidal Structures Around Edge-On Galaxies in Deep Imaging Surveys](https://arxiv.org/abs/2607.16664)
...
### [43] [Asymmetries in spatially unresolved 21-cm emission line profiles of isolated galaxies](https://arxiv.org/abs/2607.16700)
...
### [44] [Molecule-dependent Abundance Behavior of Oxygen-bearing Complex Organics in High-Mass Star-Forming Regions: A Uniform 50-source Survey](https://arxiv.org/abs/2607.16734)
...
### [45] [Predicting the unpredictable: binary--single scattering with machine learning](https://arxiv.org/abs/2607.16763)
...
### [46] [Machine learning prediction of binary formation in three-body gravitational encounters](https://arxiv.org/abs/2607.16776)
*Ahmad Farhani Asl*
...
### [47] [Temporal Correlations Between Fuzzy Dark Matter and Baryonic Matter in Virialized Core-Halo Structures](https://arxiv.org/abs/2607.16917)
...
### [48] [Disentangling the Morphology of Palomar~5: Effects of the Bar, Spiral Arms, LMC, and Halo Flattening](https://arxiv.org/abs/2607.17040)
...
### [49] [Super-Jeans Fragmentation and Supply-Limited Accretion: Environment-Dependent Co-Evolution of Low- and High-Mass Cores](https://arxiv.org/abs/2607.17215)
...
### [50] [Ongoing Morphological Transformation from Elliptical to Spiral Galaxies Induced by Gas Accretion from Neighboring Galaxies](https://arxiv.org/abs/2607.17271)
...
### [51] [The initial conditions and initial mass functions of Alpha Persei, Pleiades and Praesepe](https://arxiv.org/abs/2607.17300)
...
### [52] [A Rest-frame K-band View of Bulge Growth in Massive Dusty Star-forming Galaxies at z~2](https://arxiv.org/abs/2607.17424)
*Ken-ichi Tadaki*
...
### [53] [Anomalously high deuterium fractionation in a galactic translucent cloud: a challenge to chemical models](https://arxiv.org/abs/2607.17529)
...
### [54] [The Intrinsic Multiphase Gas--Black Hole Connection across Scales in IllustrisTNG](https://arxiv.org/abs/2607.17567)
...
### [56] [Revealing a multi-zone circumnuclear dust response in UGC~11487 through phase-resolved WISE W1--W2 diagnostics](https://arxiv.org/abs/2607.17815)
...
### [57] [Feature-driven anomaly flagging in obscured active galactic nucleus light curves with autoencoders](https://arxiv.org/abs/2607.17728)
...
### [58] [Two Peas in a Pod: The First Confirmed Dual Active Galactic Nucleus within a Green Pea Galaxy System](https://arxiv.org/abs/2607.17729)
...
### [59] [Far-Infrared Star Formation Rates of Quasar Host Galaxies from Multiwavelength Spectral Energy Distribution Decomposition](https://arxiv.org/abs/2607.17752)
...
### [60] [The stability of radially anisotropic rotating stellar systems with a central density cusp](https://arxiv.org/abs/2607.17763)
...
### [61] [Structural and dynamical properties of Tidal dwarf galaxies in the tails and bridge of the Guitar galaxy Arp 105](https://arxiv.org/abs/2607.17776)
...
### [62] [Testing [O II] $\lambda3727$ as a Star Formation Rate Tracer in Quasar Host Galaxies](https://arxiv.org/abs/2607.17788)
*Xiaotong Feng,Xue-Bing Wu,Yuming Fu,Yuxuan Pang,Rui Zhu,Huimei Wang*
...
### [63] [Spatio-kinematical structure of the Galactic Nuclear Stellar Disk revealed in VLBI astrometry of circumstellar masers](https://arxiv.org/abs/2607.17870)
...
### [64] [Ergodicity of FIRE: star formation variations within and between simulated galaxies](https://arxiv.org/abs/2607.18005)
...
### [65] [Comparing the Near-infrared Spectral Energy Distributions from Different Stellar Population Synthesis Models with SPHEREx Observations](https://arxiv.org/abs/2607.18048)
...
### [66] [The science of the cycle of matter in our Galaxy with the SKA](https://arxiv.org/abs/2607.18065)
*Marc Audard,Ke Wang*
...
### [67] [Discovery of an Unbound Flyby Companion of UBC 63: In the Immediate Aftermath of a Close Encounter](https://arxiv.org/abs/2607.18224)
