...
### [2] [On the reconstruction of the Rotation Curve for Milky Way and its spacetime implications: a Machine Learning approach](https://arxiv.org/abs/2607.15320)
...
### [3] [Tighter Dark Matter Constraints from the Projected Mass Method: A Neural Network Enhanced Method for Galaxy Groups and Clusters](https://arxiv.org/abs/2607.15339)
...
### [4] [How large can galaxies be? Ultra-deep imaging of IC 1101, the most extended known galaxy](https://arxiv.org/abs/2607.15340)
...
### [5] [The Azahar Project: Non-Thermal Physics Drives Star Formation Burstiness and the Evolution of the UV Luminosity Density at Cosmic Dawn](https://arxiv.org/abs/2607.15344)
...
### [6] [The first three-dimensional map of thermal phases in the local interstellar medium](https://arxiv.org/abs/2607.15352)
...
### [7] [Non-Thermal Physics Drives Compact, Self-Regulated Galaxy Morphologies at Cosmic Dawn](https://arxiv.org/abs/2607.15357)
...
### [8] [A JWST, ALMA and VLA survey of the Ophiuchus-A star-forming region: Unveiling hidden dust mass and connecting infrared outflows to their radio origins](https://arxiv.org/abs/2607.15468)
...
### [9] [Gas-Phase Metallicity and Nitrogen Abundances in Low-Mass Galaxies Down to $M_\star\simeq10^{5.7}\,M_\odot$ at $z\simeq4.5$--$10.1$ from JWST Lensing Cluster Surveys](https://arxiv.org/abs/2607.15515)
...
### [10] [22 Newly Identified Repeating Changing-look AGNs and Evidence for Extreme Broad-line Region Breathing](https://arxiv.org/abs/2607.15564)
...
### [11] [The FAST HI 21-cm Absorption Blind Survey. III. OH Absorption Search in the 21-cm Absorber Sample and Continued HI Absorption Search](https://arxiv.org/abs/2607.15595)
...
### [12] [Identifying and Distinguishing Quenching Galaxies with Spatially Resolved Star Formation in Mock CASTOR and NGRST Observations](https://arxiv.org/abs/2607.15638)
...
### [13] [Testing various assumptions for radiolysis, non-diffusive chemistry, and chemical desorption in cold cores](https://arxiv.org/abs/2607.15747)
*V. Wakelam,T. Tu*
...
### [14] [Chemical Evolution of Galaxies: Past, Present and Future](https://arxiv.org/abs/2607.15803)
*Francesca Matteucci*
...
### [15] [The S-PLUS Fifth Data-Release: Over 4500 square degrees of the Southern Sky and a multicolor view of the Hydra and Antlia galaxy clusters](https://arxiv.org/abs/2607.15891)
...
### [16] [Radio-detected Lya emitters at 1.88 < z < 3.52: AGN fraction and Lya emission](https://arxiv.org/abs/2607.15971)
...
### [17] [Infrared spectroscopy of gas-phase hydrogenated and methylated pyrenes: from laboratory spectra to the simulated 3.4 $μ$m emission band](https://arxiv.org/abs/2607.16018)
...
### [18] [Dynamics and geometry of the inner sub-parsec-scale jet in 3C 279 observed with the Event Horizon Telescope](https://arxiv.org/abs/2607.16104)
...
### [19] [Euclid: Calibrating distances from surface brightness fluctuations with Early Release Observations of the Fornax cluster](https://arxiv.org/abs/2607.16164)
...
### [20] [Morphologies of SAGAbg low-mass galaxies in Legacy Survey multi-band imaging: dependence on stellar masses, star-formation rates and low-redshift evolution](https://arxiv.org/abs/2607.16170)
...
### [21] [OpenCosmo: Community Portal and Analysis Framework for Flagship Cosmological Simulations](https://arxiv.org/abs/2607.16059)
...
### [22] [Star formation, stellar evolution, and planets in high-resolution X-ray imaging](https://arxiv.org/abs/2607.15474)
...
### [23] [Compressing radio interferometric visibility data into a probabilistic model using sparse Gaussian processes](https://arxiv.org/abs/2607.15860)
*Takafumi Tsukui*
...
### [24] [PBH formation and Gravitational Waves as Multi-messenger Signals of First-order Phase Transitions](https://arxiv.org/abs/2607.15479)
...
### [25] [Observations of X-ray quasi-periodic eruptions](https://arxiv.org/abs/2607.15359)
...
### [26] [Very Large Telescope observations of interstellar comet 3I/ATLAS III: High-resolution monitoring of CN and forbidden oxygen emission across the perihelion passage with ESPRESSO](https://arxiv.org/abs/2607.15355)
...
### [27] [Extending dynamical mass measurements: probing GI as a possible origin of mm-dust spirals](https://arxiv.org/abs/2607.15923)
...
### [28] [Primordial tensor mode from the neutrino sector](https://arxiv.org/abs/2607.15335)
...
### [29] [Searching for Folded Primordial Non-Gaussianity with Galaxy Surveys](https://arxiv.org/abs/2607.15337)
...
### [30] [Forest without Trees is still Fruitful: Constraints on the thermal state of the neutral IGM at $z\approx5.6$ with the 21-cm forest power spectrum](https://arxiv.org/abs/2607.15341)
...
### [31] [Tunnelling out of Starobinsky inflation: Raising the spectral tilt](https://arxiv.org/abs/2607.15354)
...
### [32] [Two-component large-scale radio emission in Abell 2244](https://arxiv.org/abs/2607.15437)
...
### [33] [Morphological Bias: How Ellipticals and Spirals Trace the Cosmic Web Differently](https://arxiv.org/abs/2607.15573)
...
### [34] [Update on the Physics of the Cosmic Microwave Background (2015-2025)](https://arxiv.org/abs/2607.15666)
*Martin Bucher*
...
### [35] [Standard Reconstruction Shifts the Optimal Input Scale for CNN-Based Density-Field Reconstruction](https://arxiv.org/abs/2607.15850)
...
### [36] [GW Microlensing: Degeneracy with Unlensed Precessing and Non-Spinning Gravitational-Wave Signals](https://arxiv.org/abs/2607.15913)
...
### [37] [Constraints on the remote quadrupole field from the polarized Sunyaev Zel'dovich effect](https://arxiv.org/abs/2607.16071)
...
### [38] [Large deviations for halos and voids: beyond perturbative non-gaussianities](https://arxiv.org/abs/2607.16152)
...
### [39] [Constraining primordial non-Gaussianity and parity-violation through Scalar-Induced Gravitational Waves with next-generation ground-based interferometers](https://arxiv.org/abs/2607.16162)
...
### [40] [Cosmological Evidence for Dark Axion-Dark Baryon Interactions from Apparent Phantom Crossing](https://arxiv.org/abs/2607.16191)
...
### [41] [Hanbury-Brown Twiss effect, squeezed gravitons and the photon correlations](https://arxiv.org/abs/2607.15964)
*Massimo Giovannini*
...
### [42] [Localized Vector Modes on Local Cosmic Strings](https://arxiv.org/abs/2607.16120)
