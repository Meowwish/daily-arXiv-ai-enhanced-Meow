...
### [1] [Bounds on $Λ$ at the Galactic Center](https://arxiv.org/abs/2606.13356)
...
### [2] [Deep optical spectroscopic monitoring of the pulsating ULX NGC 1313 X-2 with longslit Gemini observations](https://arxiv.org/abs/2606.13116)
...
### [3] [Thermodynamic coefficients in third-order relativistic fluid dynamics](https://arxiv.org/abs/2606.12463)
...
### [4] [TBD LBD: The nature of `little blue dots'](https://arxiv.org/abs/2606.12509)
...
### [5] [Unification models of Active Galactic Nuclei](https://arxiv.org/abs/2606.12511)
*Claudio Ricci*
...
### [6] [Bar-induced migration of $ω$ Centauri away from Gaia Sausage-Enceladus](https://arxiv.org/abs/2606.12516)
...
### [7] [The Hubble Missing Globular Clusters Survey IV. Ultra-faint compact satellites of the Milky Way. The case of Koposov 2](https://arxiv.org/abs/2606.12517)
...
### [8] [Dark and Luminous Matter in the Coma Cluster: Probing Galaxy Cluster Assembly Through Filaments with Weak Lensing and Multiwavelength Observations](https://arxiv.org/abs/2606.12523)
...
### [9] [Getting to know the Stellar Clusters in NGC 1569: Bayesian inference of stellar cluster properties in a dwarf starburst galaxy](https://arxiv.org/abs/2606.12536)
...
### [10] [DESI as sparse Integral Field Spectrograph I: Spatially resolved chemical enrichment in star-forming galaxies at $z\leq0.1$](https://arxiv.org/abs/2606.12541)
...
### [11] [Constraining the Geometry of Galactic Dark Matter with Gaia Data Release 3](https://arxiv.org/abs/2606.12548)
...
### [12] [CAPOS: The bulge Cluster APOgee Survey XII. Abundances for 98 PIGS metal-poor Bulge field giants](https://arxiv.org/abs/2606.12583)
...
### [13] [Influence of the resonance ring gravity on the stellar velocity distribution near the OLR of the Galactic bar](https://arxiv.org/abs/2606.12589)
...
### [14] [Feedback-Free Star Formation in Clusters within a Galaxy Simulated at High Resolution in Cosmic Dawn](https://arxiv.org/abs/2606.12605)
...
### [15] [Carbon Abundances in Metal-Poor Stars Reveal Distinct Galaxy and Star Formation Pathways in the Early Universe](https://arxiv.org/abs/2606.12617)
...
### [16] [The X-ray photon index Eddington ratio relation in radio-quiet quasars from XMM-Newton and SDSS](https://arxiv.org/abs/2606.12668)
...
### [17] [The $M_{\rm BH}$$-$$R_{\rm b}$ relation and the high-mass end of the $M_{\rm BH}$$-$$σ$ relation](https://arxiv.org/abs/2606.12669)
*Bililign Dullo*
...
### [18] [Unprecedented Constraints on Gas Flows at High Redshift Using Deep JWST/NIRSpec Observations from the LyC22, EXCELS, and AURORA Surveys](https://arxiv.org/abs/2606.12686)
...
### [19] [Supermassive Black Hole Assembly from Heavy Seeds with Dynamical Friction in the BRAHMA Simulations: Implications for JWST, LISA, and the Local Universe](https://arxiv.org/abs/2606.12851)
...
### [20] [SIDM and CDM interpretations of the million-solar-mass lensing perturber JVAS B1938+666-$\mathcal{V}$](https://arxiv.org/abs/2606.12909)
...
### [22] [Chemical signatures from the first stars embedded in metal-poor gas in galaxies at cosmic dawn](https://arxiv.org/abs/2606.13078)
...
### [23] [Grain Alignment and Dust Evolution Physics with Polarisation (GRADE-POL). II. On the physical basis of Serkowski and super-Serkowski polarisation spectra](https://arxiv.org/abs/2606.13123)
...
### [25] [Basis sets and Coulomb resolutions in rotational coordinates](https://arxiv.org/abs/2606.13324)
*Edward Lilley*
...
### [26] [Galaxy clusters in the VIDEO fields: detection and characterisation in the context of MOONRISE](https://arxiv.org/abs/2606.13359)
...
### [27] [Feedback in Extragalactic Star Clusters (FEAST): Spectral Energy Distributions and the Physical Properties of Star Clusters in NGC 628 with CIGALE](https://arxiv.org/abs/2606.13391)
...
### [28] [The ultra low-frequency spectral properties of bright extended radio galaxies in the 3CRR catalogue](https://arxiv.org/abs/2606.13493)
...
### [29] [Centrally concentrated star formation in young clusters II: Jet feedback](https://arxiv.org/abs/2606.13666)
...
### [30] [Directional dark matter signatures of the Large Magellanic Cloud](https://arxiv.org/abs/2606.12535)
...
### [33] [Observing Cosmic Reheating with the expanded Simons Observatory](https://arxiv.org/abs/2606.12519)
...
### [34] [Dark Matter with a Drag at Low Redshift](https://arxiv.org/abs/2606.12521)
...
### [35] [Magnetic fields at the dawn of structure formation I. The CARLA J1510+5958 proto-cluster](https://arxiv.org/abs/2606.12522)
...
### [36] [Complex yet Hermitian: Gaussian covariance of cross-correlation and multi-tracer power spectra](https://arxiv.org/abs/2606.12551)
...
### [37] [Galaxy formation in modified gravity -- II. galaxy halo connection and assembly bias](https://arxiv.org/abs/2606.12565)
...
### [38] [Weak Lensing Spectrotomography: A1767 and A2065](https://arxiv.org/abs/2606.12613)
...
### [39] [Identification of Lensed Gravitational-Wave Beat Patterns by LISA](https://arxiv.org/abs/2606.12792)
...
### [40] [Geometric obstruction to resolving the Hubble tension: orthogonality of scale and shape in distance measurements](https://arxiv.org/abs/2606.12822)
...
### [41] [Cluster Mass Inference from Galaxy Kinematics](https://arxiv.org/abs/2606.12938)
...
### [42] [A Review on Resolving the Hubble Tension via Late-Universe Physics](https://arxiv.org/abs/2606.12980)
...
### [43] [Machine Learning Does It and Does It Better: Unearthing Primordial Dark-Matter Velocities from the Matter Power Spectrum](https://arxiv.org/abs/2606.13527)
...
### [44] [A local Universe catalogue of structures and voids dynamically identified using Cosmic-Flows4++ZOA peculiar velocities](https://arxiv.org/abs/2606.13538)
...
### [45] [Localization of Chiral Electromagnetic Waves on Thick Axion Domain Walls](https://arxiv.org/abs/2606.12513)
*Nemanja Kaloper*
...
### [46] [Tachyonic Encore: A universal shift of inflationary observables](https://arxiv.org/abs/2606.12549)
