...
### [1] [Automatically distinguishing Rubin transients from AGN using variability metrics](https://arxiv.org/abs/2608.18823)
...
### [2] [The impact of recombination during tidal disruption events](https://arxiv.org/abs/2608.18201)
...
### [3] [An axion constraint from the diffuse supernova neutrino background indicated by Super-Kamiokande](https://arxiv.org/abs/2608.17681)
...
### [4] [Towards Quantum-Dot Detectors as Barcodes for Dark Matter Interactions](https://arxiv.org/abs/2608.18204)
...
### [6] [The Inbound Gas and Dust Evolution of Interstellar Comet 3I/ATLAS from Optical Spectroscopy and Multi-band Photometry](https://arxiv.org/abs/2608.18371)
...
### [7] [Estimation of systematic error from bulk deformation of end test mass induced by photon calibrator for LIGO post-O5 gravitational wave projects](https://arxiv.org/abs/2608.18877)
...
### [8] [Investigating the properties of nearby young moving groups using GaiaDR3](https://arxiv.org/abs/2608.18596)
...
### [9] [Mapping the Information Geometry of an Unresolved Dark Matter Population using a Differentiable Strong Lensing Simulator](https://arxiv.org/abs/2608.18224)
*Alexandre Adam*
...
### [10] [Testing MOND-like modifications to gravity using growth-rate measurements and one-loop corrections to the matter power spectrum](https://arxiv.org/abs/2608.18229)
...
### [11] [CosmoPyro: Gradients for Gravitational-Wave Cosmology](https://arxiv.org/abs/2608.18281)
...
### [12] [PowerFull: fast and accurate computation of the relativistic angular galaxy power spectrum including local primordial non-Gaussianity](https://arxiv.org/abs/2608.18334)
...
### [13] [Broadband Chiral Primordial Gravitational Waves from Constant-roll Inflation in Parity-violating Symmetric Teleparallel Gravity](https://arxiv.org/abs/2608.18649)
...
### [14] [Towards end-to-end Bayesian forward models in global 21-cm cosmology: surrogate modelling and marginalisation of beam uncertainty](https://arxiv.org/abs/2608.18962)
...
### [15] [Dipolar power asymmetry in wide-angle correlations of galaxy density, velocity and ellipticity](https://arxiv.org/abs/2608.19039)
...
### [16] [Recurrent Multi-year Mg II BAL Variability in SDSS J1333+0012](https://arxiv.org/abs/2608.18211)
...
### [17] [Quasar Impostors: Two Extremely UV-Bright ($M_{\rm UV}\approx-23.5$) Reionisation-Epoch Galaxies Powered by Very Massive Stars](https://arxiv.org/abs/2608.18212)
...
### [18] [Automated Assignment and Prediction of Molecules in Astronomical Line Surveys Using Machine-Learning-Based Chemical Embeddings](https://arxiv.org/abs/2608.18221)
...
### [19] [Accretion of AGN Stars under Influence of Disk Geometry II: The Adiabatic Regime and Runaway Collapse Induced by Self-gravity](https://arxiv.org/abs/2608.18249)
...
### [20] [Continuum Variability in AGN: Evidence for Systematically Suppressed Fluctuations in the BAL Population](https://arxiv.org/abs/2608.18287)
...
### [21] [Dynamics of tidal dwarf galaxies in the system Arp 72](https://arxiv.org/abs/2608.18385)
...
### [22] [The MAGPI Survey: Emission Line Products Data Release and the Role of Spectroscopic Aperture Covering Fraction on the Balmer Decrement-Stellar Mass Relation](https://arxiv.org/abs/2608.18464)
...
### [23] [A model for the enhanced production rate of early-type hypervelocity stars in the Galactic halo](https://arxiv.org/abs/2608.18475)
...
### [24] [Beyond Idealized PAHs: Infrared Signatures of Carbon-Chain Defects from Shock Synthesis](https://arxiv.org/abs/2608.18505)
...
### [25] [Kinematics and Dynamics of the Open Cluster NGC 2302](https://arxiv.org/abs/2608.18550)
...
### [26] [Inferring the Dark from the Observable: Estimating Halo Masses Using Galaxy Properties](https://arxiv.org/abs/2608.19154)
...
### [27] [Hector Galaxy Survey: Falling in Between - Infalling Galaxies in the Midst of the Abell 3667 Merger](https://arxiv.org/abs/2608.18621)
...
### [28] [The Total and Polarized Radio Emission from the Innermost Jets of a High-Redshift Quasar and a Candidate at Parsec-Scale Resolution](https://arxiv.org/abs/2608.18691)
...
### [29] [Size-Mass Relation Shows Its Colours: Contrasting Physical Imprints of Galaxy Evolution in Rest-Frame UV and Optical](https://arxiv.org/abs/2608.18776)
...
### [30] [The efficient star-forming regions of stripped-envelope supernovae](https://arxiv.org/abs/2608.18897)
...
### [31] [The progenitors of $z\gtrsim10$ JWST galaxies in the COLIBRE simulations](https://arxiv.org/abs/2608.19007)
...
### [32] [A comprehensive SKA Survey of lensing clusters and lensed galaxies](https://arxiv.org/abs/2608.19159)
...
### [33] [Tracing gas outflows in molecular gas-rich galaxies with the SKA](https://arxiv.org/abs/2608.19162)
...
### [34] [Diffuse HI emission in the circumgalactic medium of NGC891 and NGC4565 - III: azimuthal profiles](https://arxiv.org/abs/2608.19186)
