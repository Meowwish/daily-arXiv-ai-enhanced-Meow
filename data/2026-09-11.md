...
### [1] [For Whom Does Bell Hold?](https://arxiv.org/abs/2609.10535)
...
### [2] [Beyond the BLUE I: the advantage ceiling - how much can any estimator beat the matched filter in mm/submm survey data?](https://arxiv.org/abs/2609.10475)
*Kaustuv Basu*
...
### [3] [Uncovering the Origin of Slow Rotators among Intermediate-Mass Stars in the Star-Forming Cluster Trumpler 14](https://arxiv.org/abs/2609.11053)
...
### [4] [A Homogenized Catalogue of Variable Stars in the Globular Cluster M22: Membership, Physical Parameters, and Distance](https://arxiv.org/abs/2609.11850)
...
### [5] [Perturbations of Charged Black Holes with Higher-Order Interactions](https://arxiv.org/abs/2609.09419)
...
### [6] [Theoretical Aspects of Direct Waves in Kerr Black Holes: Pole-Splitting Method for Ringdown Analysis](https://arxiv.org/abs/2609.11908)
...
### [7] [XRISM observations of the Perseus cluster along two arms: Chaotic ICM motions probed by resonant scattering](https://arxiv.org/abs/2609.10845)
...
### [8] [Emulator-Assisted Calibration of a Semi-Analytic Galaxy Formation Model for the Roman Galaxy Redshift Survey](https://arxiv.org/abs/2609.10680)
...
### [9] [Probing dynamics of extreme galaxies I. Dark matter content in ultra-diffuse galaxies](https://arxiv.org/abs/2609.10700)
...
### [10] [Predictions for astrometric microlensing in Gaia](https://arxiv.org/abs/2609.10705)
...
### [11] [BIND (Baryonic INpainting with Deep learning): A Field-level Emulator for Galaxy Groups and Clusters](https://arxiv.org/abs/2609.10709)
...
### [12] [A Novel Approach to 3D Dust Mapping of the Central Molecular Zone](https://arxiv.org/abs/2609.10782)
...
### [13] [The THRILS Factor: Investigating the properties of Little Red Dots (LRDs) at 3<z<6 with JWST/NIRSpec](https://arxiv.org/abs/2609.10803)
...
### [14] [Studying Outflows with Synthetic Absorption Line Spectra from High Resolution Simulations](https://arxiv.org/abs/2609.10868)
...
### [15] [Impact of LSST systematics on stellar-stream density fluctuations for dark matter](https://arxiv.org/abs/2609.10897)
...
### [16] [Fast Dynamical Modelling of Milky Way Globular Clusters -- II. Impacts of Black Hole Prescriptions](https://arxiv.org/abs/2609.10955)
...
### [17] [SPURS: An Ultra-deep View Inside the Compact, Nitrogen-Enriched Nuclei of Little Red Dots](https://arxiv.org/abs/2609.11094)
...
### [18] [Nitrogen-Loud Quasars from the Dark Energy Spectroscopic Instrument. I. Sample Selection and Basic Properties](https://arxiv.org/abs/2609.11104)
...
### [19] [Black Hole-Galaxy Correlations in Cluster Zoomed-in Simulations: GIZMO-SIMBA and TNG-Cluster](https://arxiv.org/abs/2609.11191)
...
### [20] [No Detectable One-halo Galactic Conformity Signal with Halo-mass Estimates Consistent with Weak-lensing Constraints](https://arxiv.org/abs/2609.11313)
...
### [21] [Constraints on the fuzzy dark matter mass using globular clusters in dwarf galaxies from Euclid ERO data](https://arxiv.org/abs/2609.11328)
...
### [22] [The properties of central stellar knots embedded in galactic bulges of CIELO simulations](https://arxiv.org/abs/2609.11465)
...
### [23] [Tracing Warm Gas through C IV Radiative Transfer](https://arxiv.org/abs/2609.11487)
...
### [24] [Resonantly Scattered CIV Emission in Local Star-forming Galaxies: Radiative Transfer Constraints on High-ionization Gas in Reionization Analogs](https://arxiv.org/abs/2609.11497)
...
### [25] [Generating the wide sequence of Diffuse Galaxies with de Broglie waves of Dark Matter](https://arxiv.org/abs/2609.11510)
...
### [26] [Testing Chemical Tagging with LAMOST: Intrinsic Abundance Dispersion of Subgiant Stars in the Galactic Disk](https://arxiv.org/abs/2609.11555)
...
### [27] [The atomic multiphase interstellar medium of galaxies in the COLIBRE simulations](https://arxiv.org/abs/2609.11654)
...
### [28] [Learning JWST. I. A Foundation Model for New Population Discoveries and Morphology-Aware Photometric Redshift Measurements in the JADES Survey](https://arxiv.org/abs/2609.11879)
...
### [29] [Implications of Inelastic Dark Matter for Primordial Dark-Star Evolution: Kinematic Thresholds and Nonthermal Capture](https://arxiv.org/abs/2609.10662)
...
### [30] [Ultralight Axial Dark Matter](https://arxiv.org/abs/2609.10671)
...
### [31] [On the Numerical Integration of One-Loop Cosmological Collider Signals](https://arxiv.org/abs/2609.10673)
...
### [32] [Re-examining the sensitivity of JWST to decaying axion dark matter](https://arxiv.org/abs/2609.10674)
...
### [34] [Higgsino dark matter in the Starobinsky supergravity with the MSSM in light of the LUX-ZEPLIN event](https://arxiv.org/abs/2609.11241)
...
### [35] [Might the radiation era extend back to the Big Bang? On dark matter production and the relic graviton background in quadratic gravity](https://arxiv.org/abs/2609.11750)
...
### [36] [Dark Matter-Baryon Separability Predicts the Dynamics of an Almost-Dark Galaxy](https://arxiv.org/abs/2609.10661)
...
### [37] [Aletheia: Emulating the halo mass function with evolution mapping](https://arxiv.org/abs/2609.10665)
...
### [38] [The relevance of the cosmic microwave background for cosmology](https://arxiv.org/abs/2609.10672)
...
### [39] [PBH runaway during reheating](https://arxiv.org/abs/2609.10696)
...
### [40] [BINDing the lightcone: A suite of astrophysical ray-traced weak lensing and SZ maps](https://arxiv.org/abs/2609.10710)
...
### [41] [$w_0w_a$ or $bc$: DESI constraints on relative baryon-CDM perturbations](https://arxiv.org/abs/2609.10794)
...
### [42] [Constraining spinning primordial black holes with interstellar dust heating](https://arxiv.org/abs/2609.10985)
...
### [43] [Two-parameter continuous deformation of Starobinsky inflation as a bridge between Planck and ACT DESI data with $N_\star\in(50,60)$](https://arxiv.org/abs/2609.10991)
*G. German*
...
### [44] [A Tale of Two Gauges: Effective Field Theory for Relativistic Behavior of Cosmological Axions](https://arxiv.org/abs/2609.11055)
...
### [45] [(Re)constructing Accurate Axion Oscillations](https://arxiv.org/abs/2609.11056)
*Hoang Nhan Luu,Chanda Prescod-Weinstein*
...
### [46] [SMART : Spherical Mass ApeRture Toolkit](https://arxiv.org/abs/2609.11181)
...
### [47] [Initial clustering of primordial black holes: A general formulation for arbitrary local non-Gaussianity](https://arxiv.org/abs/2609.11306)
...
### [48] [TDCOSMO XXXI: New techniques in line-of-sight studies of time delay lenses](https://arxiv.org/abs/2609.11652)
...
### [49] [Reconstructing Early Primordial Black Hole Domination from Gravitational-Wave Backgrounds](https://arxiv.org/abs/2609.11891)
...
### [50] [A Multi-Axion Ladder Across Cosmic History: From Inflation, BBN, and Early Dark Energy to Late-Time Accelerated Expansion](https://arxiv.org/abs/2609.11907)
