...
### [1] [The Light Curve of Wind-Reprocessed Tidal Disruption Events](https://arxiv.org/abs/2606.11378)
...
### [2] [Gamma-Ray Constraints on Heavy Axion-Like-Particle Decays from Fermi-LAT and H.E.S.S. Blazar Spectra](https://arxiv.org/abs/2606.11923)
...
### [3] [A Jet from a Nearly Dormant Black Hole](https://arxiv.org/abs/2606.11900)
...
### [4] [Detection of a parsec-scale, compact, and fading ejecta from an accreting massive black hole](https://arxiv.org/abs/2606.11939)
...
### [5] [Identifiability of $g$ mode Resonances in Eccentric Binary Neutron Stars with Multidetector Observations](https://arxiv.org/abs/2606.11959)
...
### [6] [Modeling the impact of filter-substrate refraction in the Roman point spread function](https://arxiv.org/abs/2606.11305)
...
### [7] [Revealing Cosmic Ecosystems with the Hubble Space Telescope in 2030s and Beyond](https://arxiv.org/abs/2606.11506)
...
### [8] [Recalibration of SDSS photometric zero-points based on the InfraRed Flux Method temperature scale](https://arxiv.org/abs/2606.11587)
...
### [9] [pop-cosmos: Disentangling galaxy properties from observables using data-driven approaches](https://arxiv.org/abs/2606.11308)
...
### [10] [Comparison and verification methods to trace interaction-driven disturbances in galaxies](https://arxiv.org/abs/2606.11313)
...
### [11] [Spiral arms across cosmic time: JWST measurements of the pitch angles of spiral galaxies at $z<3.5$](https://arxiv.org/abs/2606.11315)
...
### [13] [Morphology, sizes, and scatter in a large sample of distant quiescent galaxies](https://arxiv.org/abs/2606.11328)
...
### [14] [CRIRES+ reveals the chemistry of the stellar sub-populations in the bulge fossil fragment Liller 1](https://arxiv.org/abs/2606.11329)
...
### [15] [JADES: the mass-metallicity relation at $z=1-10$. New calibrations, extremely metal-poor galaxies, and chemical diversity](https://arxiv.org/abs/2606.11345)
...
### [16] [Imprints of the Neutral Interstellar Medium on Polarized Synchrotron Emission and Faraday Rotation](https://arxiv.org/abs/2606.11359)
...
### [17] [Flagging Super-Eddington Candidates among Jetted, γ-Ray-Emitting AGN](https://arxiv.org/abs/2606.11374)
...
### [18] [SDSS-V LVM: Revealing the Physical and Chemical Structure of the Helix Nebula](https://arxiv.org/abs/2606.11394)
...
### [19] [Investigating the role of turbulence in the interstellar medium in $z\sim3$ dusty star-forming galaxies using kpc-resolution ALMA dust and gas maps](https://arxiv.org/abs/2606.11444)
...
### [20] [Geometry and Kinematics of Molecular Cloud Substructures in the Second Galactic Quadrant](https://arxiv.org/abs/2606.11733)
*Wen Ge,Fujun Du*
...
### [21] [Distinct Gas and Stellar Circular Rotation Curves in the Milky Way Galaxy](https://arxiv.org/abs/2606.11872)
...
### [22] [X-ray luminosity function of Compton-thick AGN in the early Universe (z > 3). Robustness and biases of the CTK population](https://arxiv.org/abs/2606.12076)
...
### [23] [Quenching of Star Formation in Massive Galaxies](https://arxiv.org/abs/2606.12156)
...
### [24] [Spatially Resolved Nebular-Stellar Reddening with JWST/NIRISS](https://arxiv.org/abs/2606.12249)
...
### [25] [Investigating the young stellar populations and hierarchies in nearby galaxies with the UVIT. II. Presenting the properties of ~25,000 UV-detected star-forming clumps](https://arxiv.org/abs/2606.12254)
...
### [26] [Between Degeneracy and Evolution: UV-to-optical Insights into the BH$^*$ Model in Little Red Dots](https://arxiv.org/abs/2606.12355)
...
### [27] [When direct detection constrains reheating temperature: freeze-in with stronger couplings and inflaton-seeded freeze-in](https://arxiv.org/abs/2606.12408)
...
### [28] [Interpretable Neural Marked Statistics for Cosmological Inference](https://arxiv.org/abs/2606.11295)
...
### [29] [Calibration of CMB Polarisation Using Cross-Experiment Correlations](https://arxiv.org/abs/2606.11300)
...
### [30] [Dark Energy Survey Year 3 results: optimized $w$CDM simulation-based inference with weak lensing map-level hybrid statistics](https://arxiv.org/abs/2606.11309)
...
### [31] [CMB Constraints on Pre-Inflationary Axion Dark Matter Isocurvature](https://arxiv.org/abs/2606.11312)
...
### [32] [Non-linear Structure Formation in Planck+DESI Favoured Interacting Dark Energy Cosmologies](https://arxiv.org/abs/2606.11368)
...
### [33] [Equilibrium Halo Solutions of the Gross-Pitaevskii-Poisson System: The Role of the Particle Number](https://arxiv.org/abs/2606.11545)
...
### [34] [Bayesian Constraints on Inverse-Tangent Inflation with Constant-EOS Reheating and a Dynamical Reheating Analysis](https://arxiv.org/abs/2606.11725)
...
### [35] [Nonminimal couplings and preheating effects in $R^2$-Higgs inflation after ACT and SPT](https://arxiv.org/abs/2606.11929)
...
### [36] [A Unified Halo Mass Function Across Dark Matter Models from High-Resolution Multi-Scale Simulations](https://arxiv.org/abs/2606.12137)
...
### [37] [A Stochastic Framework for the Spherical Jeans Equation Motivated by Scalar-Tensor Gravity](https://arxiv.org/abs/2606.12170)
...
### [38] [Towards Practical Field-Level Inference for Weak Lensing](https://arxiv.org/abs/2606.12255)
...
### [39] [Deep Learning Calibration of the Quasar X-ray/UV Luminosity Relation for Cosmological Applications](https://arxiv.org/abs/2606.12265)
...
### [40] [KiDS-Legacy: Joint analysis of second- and third-order cosmic shear](https://arxiv.org/abs/2606.12389)
...
### [41] [Bounding the Effect of HOD Assumptions on Small-Scale Clustering Constraints](https://arxiv.org/abs/2606.12405)
...
### [42] [Numerical Simulations of Hypervelocity Micrometeoroid Impacts: Rocky Impactors onto Icy Targets and the Role of Porosity](https://arxiv.org/abs/2606.11404)
...
### [43] [Empirical colour--effective temperature relations in the SDSS system from IRFM temperatures of GALAH and APOGEE stars](https://arxiv.org/abs/2606.11594)
...
### [44] [Protostellar Outflows at the EarliesT Stages (POETS). IX. Magnetohydrodynamic disk winds traced by SO and SO$_2$ in luminous protostars](https://arxiv.org/abs/2606.11908)
...
### [45] [A post-selected quantum model of cosmic acceleration](https://arxiv.org/abs/2606.12297)
